...
$GDXIN JointA_DATA_AGG-2019_230111_MNG.gdx
...
$CALL gdxxrw Joint_VAL_230309_PAR.xls @Joint_PAR.txt trace=0
$GDXIN Joint_VAL_230309_PAR.gdx
$LOAD sigma_KD, sigma_LD, sigma_X1, sigma_X2, sigma_X0, sigma_y, PARZ
...
EQUATIONS
 ...
 EQ40_4(i,z)     Total supply by commdities
...
*==============================================================================
 EQ40_1(j,z)..   XST(j,z) =e= B_X0(j,z)*SUM[i$XSO(j,i,z),beta_X0(j,i,z)*XS(j,i,z)
                                **rho_X0(j,z)]**(1/rho_X0(j,z));

 EQ40_2(j,i,z)${XSO(j,i,z) and [XSO(j,i,z) ne XSTO(j,z)]} ..
                 XS(j,i,z) =e= XST(j,z)/B_X0(j,z)**(1+sigma_X0(j,z))*
                                {P2(j,i,z)/[beta_X0(j,i,z)*PT(j,z)]}**sigma_X0(j,z);

 EQ40_3(i,z)..   DS_I(i,z)  =e= sum(j,DS(j,i,z)$DSO(j,i,z));

 EQ40_4(i,z)..   XS_I(i,z)  =e= sum(j,XS(j,i,z)$XSO(j,i,z));
...
*==============================================================================
 ...
 EQ49_2(j,i,z)$[XSO(j,i,z) eq XSTO(j,z)]..  P2(j,i,z) =e= PT(j,z);

 EQ49_3(j,i,z)$XSO(j,i,z)..
                 P2(j,i,z)*XS(j,i,z) =e= [PET(i,z)*EXT(i,z)]$EXTO(i,z)
                                        +[MRGN(i,z)*PWMG(i)]$MRGNO(i,z)
