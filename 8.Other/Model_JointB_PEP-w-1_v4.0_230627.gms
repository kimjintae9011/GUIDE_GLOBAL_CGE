...
*==============================================================================
 ...
 EIO(i,j,z)      Intermediate energy consumption of commodity i by industry j in region z
...
* aij(ene,j,z)      = DIO(ene,j,z)/CIO(j,z);

execute_unload 'ENERGY2',
io, v ;
...
*ttim.FX(i,zj,z) = ttimO(i,zj,z)*0.8;
 ttic.FX('18_ELEC',z) = tticO('18_ELEC',z)*3;
