...
*  Transport margins are given by the variable VTMFSD
 tmrg('20_TRANSPORT',ij,zj,z)$IMO(ij,zj,z)
...
*TIPO('21_WTRP','01_KOR') = -648.5304 ;
*TIPO('10_CHEMICAL','05_MNG') = 0.264226674 ;
...
execute_unload 'DATA_AGG-2019_TRP_230113',
*execute_unload 'DATA_AGG-2019_TRP_230111',
