...
*==============================================================================
execute_unload 'results_Model_PEP-w-1_v4.0_230906',
 valC
 valCAB
 valCABX
 valCG
...
*==============================================================================
*Execute '=gdx2xls results_Joint_PEP-w-1.gdx';
...
execute_unload "Parameters",
 ...
 rho_X1, rho_X2, sigma_KD, sigma_LD, sigma_M1, sigma_M2, sigma_VA, sigma_X0, sigma_X1,
