...
*==============================================================================*
*  This version of PEP w-t is used to endogenously compute:                    *
...
*  Projections used to compute these two factors are taken from:               *
...
*   The slope ttdh1O is calibrated below in the main GAMS file
...
*==============================================================================
 ...
 LS.FX(l,z,time)$[ord(time) gt 1]
                     = LS.l(l,z,time-1)*[1+g_LS(z,time-1)];
...
execute_unload 'B_line',
 A_VA_RES, sh0X, sh1X, GX, G_REALX, INDX;
