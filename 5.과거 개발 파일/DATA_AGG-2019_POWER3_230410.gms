...
*lt Strictly less than
 ...
 IMO('24_eSolar',zj, z)$(IMO('24_eSolar', zj, z) lt 1e-05) = 0.000001 ; 
 IMO('26_eOther',zj, z)$(IMO('26_eOther', zj, z) lt 1e-05) = 0.00001 ; 
...
*                       SUM[marg,VTMFSD(marg,comm,regj,reg)]};
  ...
  tmrg('28_LTRP',ij,zj,z)$IMO(ij,zj,z)
                 = SUM{(comm,regj,reg)$[j2comm(ij,comm)
                       $z2reg(zj,regj)$z2reg(z,reg)],
                       VTMFSD('otp',comm,regj,reg)};

  tmrg('29_WTRP',ij,zj,z)$IMO(ij,zj,z)
                 = SUM{(comm,regj,reg)$[j2comm(ij,comm)
                       $z2reg(zj,regj)$z2reg(z,reg)],
                       VTMFSD('wtp',comm,regj,reg)};

 tmrg('30_ATRP',ij,zj,z)$IMO(ij,zj,z)
                 = SUM{(comm,regj,reg)$[j2comm(ij,comm)
                       $z2reg(zj,regj)$z2reg(z,reg)],
                       VTMFSD('atp',comm,regj,reg)};

 tmrg3(ij,zj) = tmrg('28_LTRP',ij,zj,'01_KOR') ;

 tmrg4(zj) = sum(ij,tmrg('28_LTRP',ij,zj,'01_KOR')) ;
...
execute_unload 'DATA_AGG-2019_230410_POWER3',
