...
IAMC(model_IAMC, 'CPS', Country, 'Secondary Energy|Electricity|Biomass', 'EJ/yr', year_IAMC)            = valElecGen('Bio',Country,year_IAMC,'CPS')*GWhtoEJ + eps ; 
IAMC(model_IAMC, 'CPS', Country, 'Secondary Energy|Electricity|Coal', 'EJ/yr', year_IAMC)               = valElecGen('Coal',Country,year_IAMC,'CPS')*GWhtoEJ + eps ; 
IAMC(model_IAMC, 'CPS', Country, 'Secondary Energy|Electricity|Gas', 'EJ/yr', year_IAMC)                = valElecGen('Gas',Country,year_IAMC,'CPS')*GWhtoEJ + eps ; 
...
IAMC(model_IAMC, 'CPS', Country, 'Secondary Energy|Electricity|Oil', 'EJ/yr', year_IAMC)                = valElecGen('Oil',Country,year_IAMC,'CPS')*GWhtoEJ + eps;
IAMC(model_IAMC, 'CPS', Country, 'Secondary Energy|Electricity|Solar_PV', 'EJ/yr', year_IAMC)           = valElecGen('Solar',Country,year_IAMC,'CPS')*GWhtoEJ + eps;
IAMC(model_IAMC, 'CPS', Country, 'Secondary Energy|Electricity|Wind', 'EJ/yr', year_IAMC)               = valElecGen('Wind',Country,year_IAMC,'CPS')*GWhtoEJ + eps;
*IAMC(model_IAMC, 'CPS', Country, 'Secondary Energy|Hydrogen', 'EJ/yr', year_IAMC)                       = eps ; 
IAMC(model_IAMC, 'CPS', Country, 'Secondary Energy|Electricity', 'EJ/yr', year_IAMC)                    = IAMC(model_IAMC, 'CPS', Country, 'Secondary Energy|Electricity|Biomass', 'EJ/yr', year_IAMC) 
                                                                                                        + IAMC(model_IAMC, 'CPS', Country, 'Secondary Energy|Electricity|Coal', 'EJ/yr', year_IAMC)   
                                                                                                        + IAMC(model_IAMC, 'CPS', Country, 'Secondary Energy|Electricity|Gas', 'EJ/yr', year_IAMC)   
                                                                                                        + IAMC(model_IAMC, 'CPS', Country, 'Secondary Energy|Electricity|Geothermal', 'EJ/yr', year_IAMC)
                                                                                                        + IAMC(model_IAMC, 'CPS', Country, 'Secondary Energy|Electricity|Hydro', 'EJ/yr', year_IAMC)  
                                                                                                        + IAMC(model_IAMC, 'CPS', Country, 'Secondary Energy|Electricity|Nuclear', 'EJ/yr', year_IAMC)  
                                                                                                        + IAMC(model_IAMC, 'CPS', Country, 'Secondary Energy|Electricity|Oil', 'EJ/yr', year_IAMC) 
                                                                                                        + IAMC(model_IAMC, 'CPS', Country, 'Secondary Energy|Electricity|Solar_PV', 'EJ/yr', year_IAMC) 
                                                                                                        + IAMC(model_IAMC, 'CPS', Country, 'Secondary Energy|Electricity|Wind', 'EJ/yr', year_IAMC)  ;
...
IAMC(model_IAMC, 'CPS', Country, 'Final Energy|Geothermal', 'EJ/yr', year_IAMC)                         = {sum(p_geo,valEH(p_geo,Country,year_IAMC,'CPS'))+ sum((p_geo, Demand2),valEE(p_geo,Demand2,Country,year_IAMC,'CPS'))}*ktoetoEJ + eps ;
...
IAMC(model_IAMC, 'CPS', Country, 'Final Energy|Solar', 'EJ/yr', year_IAMC)                              = {sum(p_solar,valEH(p_solar,Country,year_IAMC,'CPS'))+ sum((p_solar, Demand2),valEE(p_solar,Demand2,Country,year_IAMC,'CPS'))}*ktoetoEJ + eps ;
IAMC(model_IAMC, 'CPS', Country, 'Final Energy|Solids|Biomass', 'EJ/yr', year_IAMC)                     = {sum(p_biowastecharcoal,valEH(p_biowastecharcoal,Country,year_IAMC,'CPS'))+ sum((p_biowastecharcoal, Demand2),valEE(p_biowastecharcoal,Demand2,Country,year_IAMC,'CPS'))}*ktoetoEJ + eps ;
...
IAMC(model_IAMC, 'CPS', Country, 'Final Energy|Solids', 'EJ/yr', year_IAMC)                             = IAMC(model_IAMC, 'CPS', Country, 'Final Energy|Solids|Biomass', 'EJ/yr', year_IAMC) 
                                                                                                        + IAMC(model_IAMC, 'CPS', Country, 'Final Energy|Solids|Fossil', 'EJ/yr', year_IAMC)  ; 
IAMC(model_IAMC, 'CPS', Country, 'Final Energy|Hydrogen', 'EJ/yr', year_IAMC)                           = {eps}*ktoetoEJ ;
...
IAMC(model_IAMC, 'CPS', Country, 'Final Energy', 'EJ/yr', year_IAMC)                                    = IAMC(model_IAMC, 'CPS', Country, 'Final Energy|Gases', 'EJ/yr', year_IAMC)
                                                                                                        + IAMC(model_IAMC, 'CPS', Country, 'Final Energy|Geothermal', 'EJ/yr', year_IAMC)
                                                                                                        + IAMC(model_IAMC, 'CPS', Country, 'Final Energy|Heat', 'EJ/yr', year_IAMC) 
                                                                                                        + IAMC(model_IAMC, 'CPS', Country, 'Final Energy|Electricity', 'EJ/yr', year_IAMC)
                                                                                                        + IAMC(model_IAMC, 'CPS', Country, 'Final Energy|Liquids', 'EJ/yr', year_IAMC)
                                                                                                        + IAMC(model_IAMC, 'CPS', Country, 'Final Energy|Solar', 'EJ/yr', year_IAMC)
                                                                                                        + IAMC(model_IAMC, 'CPS', Country, 'Final Energy|Solids', 'EJ/yr', year_IAMC)
                                                                                                        + IAMC(model_IAMC, 'CPS', Country, 'Final Energy|Hydrogen', 'EJ/yr', year_IAMC)  ;
...
execute_unload 'Output_w-t\CPS_Results_IAMC_GreenEcos',
 IAMC
