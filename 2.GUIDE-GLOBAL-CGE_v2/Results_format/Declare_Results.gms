...
* --- 5. Energy Demand & Supply ---
 ...
 valTES_nuc(z,time,scen)   Total Energy Supply: Nuclear
 valTES_hydro(z,time,scen) Total Energy Supply: Hydro
 valTES_solar(z,time,scen) Total Energy Supply: Solar
 valTES_wind(z,time,scen)  Total Energy Supply: Wind
 valTES_geo(z,time,scen)   Total Energy Supply: Geothermal
 valTES_bio(z,time,scen)   Total Energy Supply: Biomass
 valTES_waste(z,time,scen) Total Energy Supply: Waste
 valTES_other(z,time,scen) Total Energy Supply: Other Renewables
...
* --- 6. Emissions & Climate Policy (CO2, CH4, N2O, F-gases) ---
 ...
 valEndo_CO2IND(ene,j,z,time,scen)   Endogenous CO2 emissions by industry (kt)
 valEndo_CO2HH(ene,z,time,scen)      Endogenous CO2 emissions by households (kt)
 valEndo_EneCO2(ene,z,time,scen)    Endogenous CO2 by energy type (kt)
 valEndo_TotalCO2(z,time,scen)       Endogenous Total CO2 (kt)
 valEndo_GlobalTotalCO2(time,scen)   Endogenous Global Total CO2 (kt)
 valCO2I(product,j,z,time,scen)      Industry CO2 emissions by products (kt)
 valCO2NE(product,j,z,time,scen)     Industry non-energy consumption CO2 emissions by products (kt)
 valCO2H(product,z,time,scen)        Household CO2 emission by products  (kt)
 valCO2I2(j,z,time,scen)             Industry CO2 emissions by regions (kt)
 valCO2NE2(j,z,time,scen)            Non-energy consumption CO2 emission by industries and regions (kt)
 valCO2I3(j,z,time,scen)             Industry CO2 emissions by regions (Variant 3) (kt)
 valTCO2I(z,time,scen)               Total industrial CO2 emission by regions (kt)
 valTCO2NE(z,time,scen)              Total CO2 emission from non-energy consumption by regions (kt)
 valTCO2H(z,time,scen)               Household CO2 emission by regions (kt)
 valTCO2(z,time,scen)                Total CO2 emission by regions (kt)
 valCO2I2_FUELCOMB(j,z,time,scen)    Fuel combustion CO2 emissions by industry and region (kt)
 valTCO2H_FUELCOMB(z,time,scen)      Total Household fuel combustion CO2 emissions (kt)
 valTCO2I_FUELCOMB(z,time,scen)      Total Industrial fuel combustion CO2 emissions (kt)
 valTCO2NE_FUELCOMB(z,time,scen)     Total non-energy fuel combustion CO2 emissions (kt)
 valTCO2_FUELCOMB(z,time,scen)       Total fuel combustion CO2 emissions (kt)
 valCO2_Marine(product,z,time,scen)  Marine bunker CO2 emissions (kt)
 valTCO2_Marine(z,time,scen)         Total Marine bunker CO2 emissions (kt) 
 valCO2_Aviation(product,z,time,scen) Aviation bunker CO2 emissions (kt)
 valTCO2_Aviation(z,time,scen)       Total Aviation bunker CO2 emissions (kt)
 valCH4I(product,j,z,time,scen)      Industry CH4 emissions by regions and products (ktCO2eq)
 valCh4NE(product,j,z,time,scen)     Industry non-energy consumption CH4 emissions by products (ktCO2eq)
 valCH4I2(j,z,time,scen)             Industry CH4 emissions by regions (ktCO2eq)
 valCH4NE2(j,z,time,scen)            Non-energy consumption CH4 emission by industries and regions (ktCO2eq)
 valCH4I3(j,z,time,scen)             Industry CH4 emissions by regions (Variant 3) (ktCO2eq) 
 valTCH4I(z,time,scen)               Total industrial CH4 emission by regions (ktCO2eq)
 valTCH4NE(z,time,scen)              Total CH4 emission from non-energy consumption by regions (ktCO2eq)
 valCH4H(product,z,time,scen)        Household CH4 emission by regions (ktCO2eq)
 valTCH4H(z,time,scen)               Total Household CH4 emission by regions (ktCO2eq)
 valTCH4(z,time,scen)                Total CH4 emission by regions (ktCO2eq) 
 valCH4_Marine(product,z,time,scen)  Marine bunker CH4 emissions (ktCO2eq)
 valTCH4_Marine(z,time,scen)         Total Marine bunker CH4 emissions (ktCO2eq)
 valCH4_Aviation(product,z,time,scen) Aviation bunker CH4 emissions  (ktCO2eq)
 valTCH4_Aviation(z,time,scen)       Total Aviation bunker CH4 emissions (ktCO2eq)
 valN2OI(product,j,z,time,scen)      Industry N2O emissions by regions and products (ktCO2eq)
 valN2ONE(product,j,z,time,scen)     Industry non-energy consumption N2O emissions by products (ktCO2eq)
 valN2OI2(j,z,time,scen)             Industry N2O emissions by regions (ktCO2eq)
 valN2ONE2(j,z,time,scen)            Non-energy consumption N2O emission by industries and regions (ktCO2eq)
 valN2OI3(j,z,time,scen)             Industry N2O emissions by regions (Variant 3) (ktCO2eq) 
 valTN2OI(z,time,scen)               Total industrial N2O emission by regions (ktCO2eq)
 valTN2ONE(z,time,scen)              Total N2O emission from non-energy consumption by regions (ktCO2eq)
 valN2OH(product,z,time,scen)        Household N2O emission by regions (ktCO2eq)
 valTN2OH(z,time,scen)               Total Household N2O emission by regions (ktCO2eq)
 valTN2O(z,time,scen)                Total N2O emission by regions (ktCO2eq) 
 valN2O_Marine(product,z,time,scen)  Marine bunker N2O emissions (ktCO2eq)
 valTN2O_Marine(z,time,scen)         Total Marine bunker N2O emissions (ktCO2eq)
 valN2O_Aviation(product,z,time,scen) Aviation bunker N2O emissions (ktCO2eq)
 valTN2O_Aviation(z,time,scen)       Total Aviation bunker N2O emissions (ktCO2eq)
 valGlobal_CO2(time,scen)            Globally total CO2 emission (ktCO2eq)
 valGlobal_CH4(time,scen)            Globally total CH4 emission (ktCO2eq) 
 valGlobal_N2O(time,scen)            Globally total N2O emission (ktCO2eq)
 valGlobal_Fgases(time,scen)         Globally total Fgases emission (ktCO2eq)
 valGlobal_GHG(time,scen)            Globally total GHGs emission (ktCO2eq)
 valEndoAbate_IND(ene,j,z,time,scen) Endogenous emission factor improvement rate by fuel for industry (relative to 2019)
 valEndoAbate_HH(ene,z,time,scen)    Endogenous emission factor improvement rate by fuel for households (relative to 2019)
 valNONCO2_RR(z,time,scen) Non-CO2 Reduction Rate
...
* --- 9. Population ---
  valPOP(z,time,scen) unit 1000 people

* --- 10. IAMC Format ---
  IAMC(model_IAMC, scen, z, variable_IAMC, Unit_IAMC, time) Integrated Assessment Modeling Consortium (IAMC)  Format

* --- 11. IPCC Format ---
  IPCC(model_IPCC , scen, z, IPCC06_Sector, IPCC06_Code, IPCC06_Category, Substance, Unit_IPCC, time) Intergovernmental Panel on Climate Change (IPCC) Format 

* --- 12. db_CGE_output Format ---
  db_CGE(*,*,*, z, time, scen) db_CGE_output Format ;
