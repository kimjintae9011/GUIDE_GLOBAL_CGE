...
$LOAD TOT_POP, g_GDP, g_POP, g_SDR, CTAX_BAU, PERMIT_NDC, PERMIT_NZ, AEEI_BAU, AEEI_NDC, AEEI_NZ,
...
* CES - composite Power sector
 sigma_POWER(z)                   = 3;
* sigma_POWER('07_NAM')            = 1.5;
 sigma_POWER('09_WEU')            = 2.0;
* sigma_POWER('16_APC')            = 1.5;
...
* Energy & CO2 emission
*==============================================================================
$INCLUDE Input_CGE/DATA_WEB_2025.gms
