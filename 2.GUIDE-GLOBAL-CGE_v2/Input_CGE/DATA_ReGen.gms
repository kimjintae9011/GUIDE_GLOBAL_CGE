...
* 증발한 수출 및 마진 물량을 파트너 국가의 내수(DDO, CO)가 흡수하게 하여 RKDO 방어
...
*================================================================================
execute_unload 'Input_CGE\DATA_AGG-2019_GTAP11c_Regen_V2.gdx',
*Sets
 J, I, BUS, F, L, K, Z, ZR, Z1, 
...
*Parameters for RD-CGE
 TOT_POP, g_GDP, g_POP, g_SDR, CTAX_BAU, PERMIT_NDC, PERMIT_NZ, AEEI_BAU, AEEI_NDC, AEEI_NZ;
