...
* Formula: ktoe * 41.868 (TJ conversion) * CO2EF (tC/TJ) * (44/12) = tCO2
* -------------------------------------------------------------------
Emiss_CO2(j,z) = 
  sum(p_coal, 
...
Parameters
    ...
    CO2FACTORHH(ene,z)     "Time series CO2 emissions factor for household (tCO2 per 100$)"
    ...
    CO2FACTORHH2(ene,z,time)     "Time series CO2 emissions factor for household (tCO2 per 100$)"
;
...
CO2FACTORHH('02_COAL',z)$(CO('02_COAL',z) > 0) 
    = GHG_Energy_HH('02_COAL',z) / (CO('02_COAL',z) * 10000000);

CO2FACTORHH('03_OIL',z)$(CO('03_OIL',z) > 0) 
    = GHG_Energy_HH('03_OIL',z) / (CO('03_OIL',z) * 10000000);

CO2FACTORHH('04_GAS',z)$(CO('04_GAS',z) > 0) 
    = GHG_Energy_HH('04_GAS',z) / (CO('04_GAS',z) * 10000000);

CO2FACTORHH('10_PETROLCOAL',z)$(CO('10_PETROLCOAL',z) > 0) 
...
CO2FACTORHH2(ene,z,time) = CO2FACTORHH(ene,z);

* -------------------------------------------------------------------
* 6. Non 1.A Sector emission and coefficient
* -------------------------------------------------------------------
Parameter NONCO2(IPCC06_CODE,Substance,z)  ;
$call csv2gdx Input_CGE/2019_EDGAR.csv output=Input_CGE/2019_EDGAR.gdx id=NONCO2 index=1,2,3 values=4 useHeader=yes
$gdxIn Input_CGE/2019_EDGAR.gdx
$load NONCO2
$gdxIn

Parameter NONCO2_coef(IPCC06_CODE,Substance,z)  ;
NONCO2_coef('1.B.1',Substance,z) = NONCO2('1.B.1',Substance,z)/QO('02_COAL',z);
NONCO2_coef('1.B.2',Substance,z) = NONCO2('1.B.2',Substance,z)/[QO('03_OIL',z)+QO('04_GAS',z)];
NONCO2_coef('2.A.1',Substance,z) = NONCO2('2.A.1',Substance,z)/XSO('12_Nonmet','12_Nonmet',z);
NONCO2_coef('2.A.2',Substance,z) = NONCO2('2.A.2',Substance,z)/XSO('12_Nonmet','12_Nonmet',z);
NONCO2_coef('2.A.3',Substance,z) = NONCO2('2.A.3',Substance,z)/XSO('12_Nonmet','12_Nonmet',z);
NONCO2_coef('2.A.4',Substance,z) = NONCO2('2.A.4',Substance,z)/XSO('11_CHEMICAL','11_CHEMICAL',z);
NONCO2_coef('2.B',Substance,z)    = NONCO2('2.B',Substance,z)/XSO('11_CHEMICAL','11_CHEMICAL',z);
NONCO2_coef('2.C',Substance,z)    = NONCO2('2.C',Substance,z)/XSO('13_IRONSTL','13_IRONSTL',z);
NONCO2_coef('2.D',Substance,z)    = NONCO2('2.D',Substance,z)/XSO('11_CHEMICAL','11_CHEMICAL',z);
NONCO2_coef('2.E',Substance,z)    = NONCO2('2.E',Substance,z)/XSO('15_MACHINE','15_MACHINE',z);
NONCO2_coef('2.F',Substance,z)    = NONCO2('2.F',Substance,z)/XSO('15_MACHINE','15_MACHINE',z);
NONCO2_coef('2.G',Substance,z)    = NONCO2('2.G',Substance,z)/XSO('15_MACHINE','15_MACHINE',z);
NONCO2_coef('3.A.1',Substance,z)  = NONCO2('3.A.1',Substance,z)/XSO('01_AGRICULT','01_AGRICULT',z);
NONCO2_coef('3.A.2',Substance,z)  = NONCO2('3.A.2',Substance,z)/XSO('01_AGRICULT','01_AGRICULT',z);
NONCO2_coef('3.C.1',Substance,z)  = NONCO2('3.C.1',Substance,z)/XSO('01_AGRICULT','01_AGRICULT',z);
NONCO2_coef('3.C.2',Substance,z)  = NONCO2('3.C.2',Substance,z)/XSO('01_AGRICULT','01_AGRICULT',z);
NONCO2_coef('3.C.3',Substance,z)  = NONCO2('3.C.3',Substance,z)/XSO('01_AGRICULT','01_AGRICULT',z);
NONCO2_coef('3.C.4',Substance,z)  = NONCO2('3.C.4',Substance,z)/XSO('01_AGRICULT','01_AGRICULT',z);
NONCO2_coef('3.C.5',Substance,z)  = NONCO2('3.C.5',Substance,z)/XSO('01_AGRICULT','01_AGRICULT',z);
NONCO2_coef('3.C.6',Substance,z)  = NONCO2('3.C.6',Substance,z)/XSO('01_AGRICULT','01_AGRICULT',z);
NONCO2_coef('3.C.7',Substance,z)  = NONCO2('3.C.7',Substance,z)/XSO('01_AGRICULT','01_AGRICULT',z);
NONCO2_coef('4.A',Substance,z)     = NONCO2('4.A',Substance,z)/GDP_MP_REALO(z);
NONCO2_coef('4.B',Substance,z)     = NONCO2('4.B',Substance,z)/GDP_MP_REALO(z);
NONCO2_coef('4.C',Substance,z)     = NONCO2('4.C',Substance,z)/GDP_MP_REALO(z);
NONCO2_coef('4.D',Substance,z)     = NONCO2('4.D',Substance,z)/GDP_MP_REALO(z);
NONCO2_coef('5.A',Substance,z)     = NONCO2('5.A',Substance,z)/GDP_MP_REALO(z);
NONCO2_coef('5.B',Substance,z)     = NONCO2('5.B',Substance,z)/GDP_MP_REALO(z);