...
*Coal
 ...
 sigma_ENER_coalgas('20_eCoal','01_KOR')  = 1.5;
 sigma_ENER_oilprod('20_eCoal','01_KOR')   = 0.4 ;

*Gas
 sigma_ENER_coalgas(j,'01_KOR')  = 1.1;
...
*Level 5_1 (Coal/Gas)
 ...
 beta_ENER_coalgas(ene5,j2,z)
                 = [PO4(ene5,j2,z)*DEO(ene5,j2,z)**(1+rho_ENER_coalgas(j2,z))]/
                   ...
                   **(1+rho_ENER_coalgas(j2,z))];
 B_ENER_coalgas(j2,z)
                 = DEcoalgasO(j2,z)/{SUM[ene5,beta_ENER_coalgas(ene5,j2,z)*DEO(ene5,j2,z)
                   **(-rho_ENER_coalgas(j2,z))]**(-1/rho_ENER_coalgas(j2,z))};
...
*Level 5_2 (oil/petrol)
 ...
 beta_ENER_oilprod(ene6,j2,z)
                 = [PO4(ene6,j2,z)*DEO(ene6,j2,z)**(1+rho_ENER_oilprod(j2,z))]/
                   ...
                   **(1+rho_ENER_oilprod(j2,z))];
 B_ENER_oilprod(j2,z)
                 = DEoilpetrolO(j2,z)/{SUM[ene6,beta_ENER_oilprod(ene6,j2,z)*DEO(ene6,j2,z)
                   **(-rho_ENER_oilprod(j2,z))]**(-1/rho_ENER_oilprod(j2,z))};
...
*Level 4 (Coal-Gas/Oil-Petrol)
 ...
 B_ENER_nelec(j2,z)
                 = DEnelecO(j2,z)
                   ...
                   (1-beta_ENER_nelec(j2,z))*DEoilpetrolO(j2,z)**(-rho_ENER_nelec(j2,z))
...
*Level 2 (Elec/Non Elec)
 ...
 B_ENER_elec(j2,z)
                 = CEO(j2,z)
                   ...
                   (1-beta_ENER_elec(j2,z))*DEnelecO(j2,z)**(-rho_ENER_elec(j2,z))
...
*B_KLE(j,z)$KLEO(j,z)
*                 = KLEO(j,z)
*                   /{[beta_KLE(j,z)*(VAO(j,z)+EPS)**(-rho_KLE(j,z))+
*                   (beta_KLE2(j,z))*(CEO(j,z)+EPS)**(-rho_KLE(j,z))
*                   ]**(-1/rho_KLE(j,z))};
...
* GDP_IBO(z)      = SUM[(l,j),WO(l,z)*LDO(l,j,z)]+SUM[(k,j),RO(k,j,z)*KDO(k,j,z)]
 GDP_IBO(z)      = SUM[(j),WO(z)*LDO(j,z)]+SUM[(k,j),RO(k,j,z)*KDO(k,j,z)]
                   +TPRODNO(z)+TPRCTSO(z);
...
*==============================================================================
 switch(i3,z,time)  = 0 ;
 penetration_rate(i3,z,time) = eps ;

Parameters
 Max_Pen(i3,z)           Maximum Penetration Rate
 Logistic_Coeff(i3,z)    Logistic Growth Rate Coefficient
 Gompertz_Coeff(i3,z) Gompertz  Growth Rate Coefficient
 Start_Year(i3, z)        First Year
 Inflection_Lapse(i3, z) Inflection Point Time
; 
...
*==============================================================================
*  Own-price elasticities (Uncompensated)
*==============================================================================
PARAMETER
...
* XS_I2(i,z,time)          Total output of commodity i in region z
...
* EQ53_1(j,z,time)       TIW Share
* EQ53_1(k,j,z,time)     TIK Share
...
*==============================================================================
 ...
 EQ8(k,j,z,t)$KDO(k,j,z)..
                  KD(k,j,z,t) =e= [beta_KD(k,j,z)*RC(j,z,t)/RTI(k,j,z,t)]**sigma_KD(j,z)*B_KD(j,z)**(sigma_KD(j,z)-1)
                    * (KDC(j,z,t) - sum(kj, KBS(kj,j,z,t)));

 EQ9(nene,j,z,t)..   DI(nene,j,z,t) =e= aij(nene,j,z)*CI(j,z,t) ;

* EQ9_1(ene,j3,z,t)..  DE(ene,j3,z,t)   =e= aij2(ene,j3,z)*CE(j3,z,t)*AEEI(z,t) ;
 EQ9_1(ene,j3,z,t)..  DE(ene,j3,z,t)   =e= aij2_t(ene,j3,z,t)*CE(j3,z,t)*AEEI(z,t) ;
...
*=============================Level 1, 2, 3 (CES) =======================================
 EQ9_2(j2,z,t)..        CE(j2,z,t)  =e= B_ENER_elec(j2,z)*{[(beta_ENER_elec(j2,z))*DEelec(j2,z,t)**(-rho_ENER_elec(j2,z))]
                                           +[(1-beta_ENER_elec(j2,z))*DEnelec(j2,z,t)**(-rho_ENER_elec(j2,z))]
                                            }**(-1/rho_ENER_elec(j2,z));

 EQ9_3(j2,z,t)..        DEnelec(j2,z,t) =e= {[(1-beta_ENER_elec(j2,z))/(beta_ENER_elec(j2,z))]
                                        *[PCEelec(j2,z,t)/PCEnelec(j2,z,t)]}**sigma_ENER_elec(j2,z)*DEelec(j2,z,t);

 EQ9_4(j2,z,t)..        DEnelec(j2,z,t) =e= B_ENER_nelec(j2,z)*{[(beta_ENER_nelec(j2,z))*DEcoalgas(j2,z,t)**(-rho_ENER_nelec(j2,z))]
                                           +[(1-beta_ENER_nelec(j2,z))*DEoilpetrol(j2,z,t)**(-rho_ENER_nelec(j2,z))]
                                            }**(-1/rho_ENER_nelec(j2,z));

 EQ9_5(j2,z,t)..        DEoilpetrol(j2,z,t) =e= {[(1-beta_ENER_nelec(j2,z))/(beta_ENER_nelec(j2,z))]
 ...
 EQ9_7(ene5,j2,z,t)..   DE(ene5,j2,z,t) =e= [beta_ENER_coalgas(ene5,j2,z)*PCEcoalgas(j2,z,t)/(P4(ene5,j2,z,t)+P4(ene5,j2,z,t)*CTAX(z,t)*CO2FACTOR2(ene5,j2,z,t))]
                                            **sigma_ENER_coalgas(j2,z)*B_ENER_coalgas(j2,z)**(sigma_ENER_coalgas(j2,z)-1)
                                            *DEcoalgas(j2,z,t)*AEEI(z,t);

 EQ9_8(ene6,j2,z,t)..   DE(ene6,j2,z,t) =e= [beta_ENER_oilprod(ene6,j2,z)*PCEoilpetrol(j2,z,t)/(P4(ene6,j2,z,t)+P4(ene6,j2,z,t)*CTAX(z,t)*CO2FACTOR2(ene6,j2,z,t))]
...
*==============================================================================
 ...
 EQ11(z,t)..       YHL(z,t) =e= SUM[(j)$LDO(j,z),W(z,t)*(LD(j,z,t)+LBS(j,z,t))];
...
*==============================================================================
 ...
 EQ26(j,z,t)$LDO(j,z)..
                        TIW(j,z,t) =e= ttiw(j,z,t)*W(z,t)*(LD(j,z,t)+LBS(j,z,t)) -LaborRebate(j,z,t);
...
*   5.3.3 Demand
*==============================================================================
 EQ36(i,z,t)..  PC(i,z,t)*C(i,z,t) =e= PC(i,z,t) * (CMIN(i,z,t))
...
* EQ40_5(i,z,t)..   XS_I2(i,z,t) =e= B_X1(i,z)*{
...
* EQ53(j,z)..     WC(j,z)*LDC(j,z) =e= SUM[l$LDO(l,j,z),WTI(l,j,z)*LD(l,j,z)];
 EQ53(j,z,t)..     WC(j,z,t)*LDC(j,z,t) =e= WTI(j,z,t)*(LD(j,z,t)+LBS(j,z,t));
...
* EQ55(j,z,t)$KDCO(j,z)..
*                RC(j,z,t)*KDC(j,z,t) =e= SUM[k$KDO(k,j,z),RTI(k,j,z,t)*(KD(k,j,z,t)+KBS(k,j,z,t))];
...
*==============================================================================
 ...
 EQ71_2(i3,z,t)..  Q(i3,z,t) + XDBS(i3,z,t) =e= C(i3,z,t) + CG(i3,z,t) + INV(i3,z,t) + DIT(i3,z,t);
* EQ71_2(i3,z,t)..  Q(i3,z,t) =e= C(i3,z,t) + CG(i3,z,t) + INV(i3,z,t) + DIT(i3,z,t);
...
*==============================================================================
 ...
 EQ82(z,t)..       GDP_MP(z,t) =e= GDP_BP(z,t)+TPRCTS(z,t)+TCTAX(z,t)+SUM(i3,MARKUP(i3,z,t));

 EQ83(z,t)..       GDP_IB(z,t) =e= SUM[(j)$LDO(j,z),W(z,t)*(LD(j,z,t)+LBS(j,z,t))]
                              +SUM[(k,j)$KDO(k,j,z),R(k,j,z,t)*(KD(k,j,z,t)+KBS(k,j,z,t))]
                              +TPRCTS(z,t)+TPRODN(z,t)+TCTAX(z,t)+SUM(i3,MARKUP(i3,z,t));
...
*==============================================================================
 EQ98(i3,z,t)..    C_Conventional(i3,z,t) =e= (1-penetration_rate(i3,z,t))*[C(i3,z,t)+CG(i3,z,t)+INV(i3,z,t)+DIT(i3,z,t)];

 EQ99(i3,z,t)..    XDBS(i3,z,t) =e= penetration_rate(i3,z,t)*[C(i3,z,t)+CG(i3,z,t)+INV(i3,z,t)+DIT(i3,z,t)];

* EQ99(i3,z,t)..    XDBS(i3,z,t) =e= penetration_rate(i3,z,t) * XS_I2(i3,z,t);
 ...
 EQ103(i3,z,t)..   CLBS(i3,z,t)  =e= sum{j$INDtoCOM(i3,j),LBS(j,z,t)*WTI(j,z,t)};

 EQ104(i3,z,t)..   CKBS(i3,z,t) =e= sum{ j$INDtoCOM(i3,j), sum( k $ KDO(k,j,z), KBS(k,j,z,t)*RTI(k,j,z,t))};
 
 EQ105(i3,z,t)..   MARKUP(i3,z,t) =e= {P(i3,z,t)*XDBS(i3,z,t)-CLBS(i3,z,t)-CKBS(i3,z,t)} ; 

* EQ105_1(i,z,t)..  XS_I2(i,z,t) =e= XS_I(i,z,t) + XDBS(i,z,t);
...
*==============================================================================
* For Own price elasticity experiment  1
*==============================================================================  
 ttic.fx(i,z,time)$(not (sameas(z, "01_KOR") and sameas(i, "02_COAL"))) = tticO(i,z);
...
*==============================================================================
* For Own price elasticity experiment  2
*==============================================================================  
PC.fx("02_COAL",'01_KOR',time) = PCO("02_COAL",'01_KOR')*(1+0.01);
...
*==============================================================================
PARAMETER
 valPC(ene,z,time,scen)        Purchaser price of composite commodity i (including all taxes and margins) in region z
 valQ(ene,z,time,scen)         Quantity demanded of composite commodity i in region z
 valDE(ene,j,z,time,scen)     Intermediate consumption(energy) of commodity i by industry j in region z
 valC(ene,z,time,scen)         Consumption of commodity i by households in region z 
 valcoal_elas(z)     
 valgas_elas(z)               
 valpetrolcoal_elas(z)   
 valelec_elas(z)
 valsigma_Y(i,z,scen)
;
...
*==============================================================================
 valPC(ene,z,time,'bau')      = PC.l(ene,z,time);
 valQ(ene,z,time,'bau')       = Q.l(ene,z,time);
 valDE(ene,j,z,time,'bau')   = DE.l(ene,j,z,time);
 valC(ene,z,time,'bau')       = C.l(ene,z,time);
 valcoal_elas(z)                 = ((valQ('02_COAL',z,'2019','bau')-QO('02_COAL',z))/QO('02_COAL',z))/((valPC('02_COAL',z,'2019','bau')-PCO('02_COAL',z))/PCO('02_COAL',z)); 
 valgas_elas(z)                  = ((valQ('04_GAS',z,'2019','bau')-QO('04_GAS',z))/QO('04_GAS',z))/((valPC('04_GAS',z,'2019','bau')-PCO('04_GAS',z))/PCO('04_GAS',z)); 
 valpetrolcoal_elas(z)         = ((valQ('10_PETROLCOAL',z,'2019','bau')-QO('10_PETROLCOAL',z))/QO('10_PETROLCOAL',z))/((valPC('10_PETROLCOAL',z,'2019','bau')-PCO('10_PETROLCOAL',z))/PCO('10_PETROLCOAL',z)); 
 valelec_elas(z)                  = ((valQ('18_ELEC',z,'2019','bau')-QO('18_ELEC',z))/QO('18_ELEC',z))/((valPC('18_ELEC',z,'2019','bau')-PCO('18_ELEC',z))/PCO('18_ELEC',z)); 
 valsigma_Y(ene,z,scen)      = sigma_Y(ene,z);
 
* GDX 파일명을 짧게 변경하여 경로 오류 가능성을 줄입니다.
execute_unload 'valelas', valPC, valQ, valC, valDE, valcoal_elas,  valgas_elas,  valpetrolcoal_elas,  valelec_elas,   valsigma_Y ;       

$ONTEXT
execute_unload 'valcoal_elas', valcoal_elas  ;
execute_unload 'valgas_elas', valgas_elas  ;
execute_unload 'valpetrolcoal_elas', valpetrolcoal_elas  ;
execute_unload 'valelec_elas', valelec_elas  ;

execute 'gdxxrw.exe valcoal_elas.gdx par=valcoal_elas rng=Sheet1!a1' ;
execute 'gdxxrw.exe valgas_elas.gdx par=valgas_elas rng=Sheet1!a1' ;
execute 'gdxxrw.exe valpetrolcoal_elas.gdx par=valpetrolcoal_elas rng=Sheet1!a1' ;
execute 'gdxxrw.exe valelec_elas.gdx par=valelec_elas rng=Sheet1!a1' ;
$OFFTEXT
