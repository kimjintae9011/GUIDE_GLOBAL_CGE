...
*    5.3.2.2 Government
*==============================================================================
 EQ16(z,t)..       YG(z,t) =e= TDH(z,t)+TPRODN(z,t)+TPRCTS(z,t)+REBATE(z,t)*recycle_gov(z,t)-sum(i1,PC(i1,z,t)*Q_DAC(z,t)*DAC_Tech_Coeff(i1));
...
*   5.3.6 Equilibrium
*==============================================================================
 EQ71(i1,z,t)..    Q(i1,z,t) =e= C(i1,z,t)+CG(i1,z,t)+INV(i1,z,t)+DIT(i1,z,t)+(Q_DAC(z,t)*DAC_Tech_Coeff(i1));
...
*==============================================================================
 EQ81(z,t)..       GDP_BP(z,t) =e= SUM[j,PVA(j,z,t)*VA(j,z,t)]+TIPT(z,t)+sum(i3, CLBS(i3,z,t)+CKBS(i3,z,t)) ;
...
* WALRAS(z,t)..   LEON(z,t) =e= LS(z,t) -SUM[j$LDO(j,z),LD(j,z,t)]; 
...
*==============================================================================
 ...
 EQ103(i3,z,t)..   CLBS(i3,z,t)  =e= sum{j$INDtoCOM(i3,j),LBS(j,z,t)*W(z,t)};

 EQ104(i3,z,t)..   CKBS(i3,z,t) =e= sum{ j$INDtoCOM(i3,j), sum(k$KDO(k,j,z), KBS(k,j,z,t)*R(k,j,z,t))};

 EQ105(i3,z,t)..   MARKUP(i3,z,t) =e= {PC(i3,z,t)*XDBS(i3,z,t)-CLBS(i3,z,t)-CKBS(i3,z,t)};
...
*==============================================================================
 ...
 EQ108(z,t)..  PERMIT_TOTAL(z,t) =e=  sum(j,PERMIT(j,z,t))-Q_DAC(z,t)*switchDAC(z,t);
...
* 9 DAC
*==============================================================================
EQ118(z,t)..    Q_DAC(z,t) =e= DAC_MAX*DAC_growth_rate(z,t)*switchDAC(z,t);
