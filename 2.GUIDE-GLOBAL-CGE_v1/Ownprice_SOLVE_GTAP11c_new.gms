...
* ttic.fx(i,z,time)            = tticO(i,z);
 ttic.fx(i,z,time)$(not sameas(i, "02_COAL")) = tticO(i,z);
* ttic.fx(i,z,time)$(not sameas(i, "04_GAS")) = tticO(i,z);
* ttic.fx(i,z,time)$(not sameas(i, "10_PETROLCOAL")) = tticO(i,z);
* ttic.fx(i,z,time)$(not sameas(i, "18_ELEC")) = tticO(i,z);
...
*==============================================================================  
PC.fx("02_COAL",z,time) = PCO("02_COAL",z)*(1+0.01);
*PC.fx("04_GAS",z,time) = PCO("04_GAS",z)*(1+0.01);
*PC.fx("10_PETROLCOAL",z,time) = PCO("10_PETROLCOAL",z)*(1+0.01);
*PC.fx("18_ELEC",z,time) = PCO("18_ELEC",z)*(1+0.01);
