...
*$Ontext
*================== Backstop technology ===========================================================
 valswitch(i3,z,time,'NZ') = switch(i3,z,time) ;
 valpenetration_rate(i3,z,time,'NZ') = penetration_rate(i3,z,time) ;  
 valC_Conventional(i3,z,time,'NZ') = C_Conventional.l(i3,z,time) ;
