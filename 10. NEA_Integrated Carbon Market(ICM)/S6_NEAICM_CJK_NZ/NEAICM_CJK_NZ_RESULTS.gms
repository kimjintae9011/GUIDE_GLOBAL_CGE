...
*==============================================================================
 valA_VA(z,time,'NEAICM_CJK_NZ')       = A_VA.l(z,time);
 valC(i,z,time,'NEAICM_CJK_NZ')        = C.l(i,z,time);
 valCAB(z,time,'NEAICM_CJK_NZ')        = CAB.l(z,time);
 valCABX(z,time,'NEAICM_CJK_NZ')       = CABX.l(z,time);
 valCG(i,z,time,'NEAICM_CJK_NZ')       = CG.l(i,z,time);
 valCI(j,z,time,'NEAICM_CJK_NZ')       = CI.l(j,z,time);
 valCE(j,z,time,'NEAICM_CJK_NZ')       = CE.l(j,z,time);
 valCMIN(i,z,time,'NEAICM_CJK_NZ')     = CMIN.l(i,z,time);
 valCTH(z,time,'NEAICM_CJK_NZ')        = CTH.l(z,time);
 valCTH_REAL(z,time,'NEAICM_CJK_NZ')   = CTH_REAL.l(z,time);
 valDD(i,z,time,'NEAICM_CJK_NZ')       = DD.l(i,z,time);
 valDEP(z,time,'NEAICM_CJK_NZ')        = DEP.l(z,time);
 valDI(i,j,z,time,'NEAICM_CJK_NZ')     = DI.l(i,j,z,time);
 valDE(i,j,z,time,'NEAICM_CJK_NZ')     = DE.l(i,j,z,time);
 valDIT(i,z,time,'NEAICM_CJK_NZ')      = DIT.l(i,z,time);
 valDS(j,i,z,time,'NEAICM_CJK_NZ')     = DS.l(j,i,z,time);
 valDS_I(i,z,time,'NEAICM_CJK_NZ')     = DS_I.l(i,z,time);
 vale(z,time,'NEAICM_CJK_NZ')          = e.l(z,time);
 valEX(i,z,zj,time,'NEAICM_CJK_NZ')    = EX.l(i,z,zj,time);
 valEXT(i,z,time,'NEAICM_CJK_NZ')      = EXT.l(i,z,time);
 valG(z,time,'NEAICM_CJK_NZ')          = G.l(z,time);
 ValG_REAL(z,time,'NEAICM_CJK_NZ')     = G_REAL.L(z,time);
 valGDP_BP(z,time,'NEAICM_CJK_NZ')     = GDP_BP.l(z,time);
 valGDP_BP_REAL(z,time,'NEAICM_CJK_NZ')= GDP_BP_REAL.l(z,time);
 valGDP_BP_W(time,'NEAICM_CJK_NZ')     = GDP_BP_W.l(time);
 valGDP_BP_W_REAL(time,'NEAICM_CJK_NZ')= GDP_BP_W_REAL.l(time);
 valGDP_FD(z,time,'NEAICM_CJK_NZ')     = GDP_FD.l(z,time);
 valGDP_IB(z,time,'NEAICM_CJK_NZ')     = GDP_IB.l(z,time);
 valGDP_MP(z,time,'NEAICM_CJK_NZ')     = GDP_MP.l(z,time);
 valGDP_MP_REAL(z,time,'NEAICM_CJK_NZ')= GDP_MP_REAL.l(z,time);
 valIM(i,zj,z,time,'NEAICM_CJK_NZ')    = IM.l(i,zj,z,time);
 valIMT(i,z,time,'NEAICM_CJK_NZ')      = IMT.l(i,z,time);
 valIND(k,j,z,time,'NEAICM_CJK_NZ')    = IND.l(k,j,z,time);
 valINV(i,z,time,'NEAICM_CJK_NZ')      = INV.l(i,z,time);
 valIR(z,time,'NEAICM_CJK_NZ')         = IR.l(z,time);
 valIT(z,time,'NEAICM_CJK_NZ')         = IT.l(z,time);
 valIT_REAL(z,time,'NEAICM_CJK_NZ')    = IT_REAL.l(z,time);
 valKD(k,j,z,time,'NEAICM_CJK_NZ')     = KD.l(k,j,z,time);
 valKDC(j,z,time,'NEAICM_CJK_NZ')      = KDC.l(j,z,time);
 valKS(k,z,time,'NEAICM_CJK_NZ')       = KS.l(k,z,time);
 valLD(j,z,time,'NEAICM_CJK_NZ')       = LD.l(j,z,time);
 valLDC(j,z,time,'NEAICM_CJK_NZ')      = LDC.l(j,z,time);
 valLS(z,time,'NEAICM_CJK_NZ')         = LS.l(z,time);
 valLST(z,time,'NEAICM_CJK_NZ')        = LST.l(z,time);
 valMRGN(i,z,time,'NEAICM_CJK_NZ')     = MRGN.l(i,z,time);
 valP(i,z,time,'NEAICM_CJK_NZ')        = P.l(i,z,time);
 valPC(i,z,time,'NEAICM_CJK_NZ')       = PC.l(i,z,time);
 valPCI(j,z,time,'NEAICM_CJK_NZ')      = PCI.l(j,z,time);
 valPCE(j,z,time,'NEAICM_CJK_NZ')      = PCE.l(j,z,time);
 valPD(i,z,time,'NEAICM_CJK_NZ')       = PD.l(i,z,time);
 valPE(i,z,zj,time,'NEAICM_CJK_NZ')    = PE.l(i,z,zj,time);
 valPET(i,z,time,'NEAICM_CJK_NZ')      = PET.l(i,z,time);
 valphi(z,time,'NEAICM_CJK_NZ')        = phi.l(z,time);
 valPIXCON(z,time,'NEAICM_CJK_NZ')     = PIXCON.l(z,time);
 valPIXGDP(z,time,'NEAICM_CJK_NZ')     = PIXGDP.l(z,time);
 valPIXGDP_W(time,'NEAICM_CJK_NZ')     = PIXGDP_W.l(time);
 valPIXGVT(z,time,'NEAICM_CJK_NZ')     = PIXGVT.l(z,time);
 valPIXINV(z,time,'NEAICM_CJK_NZ')     = PIXINV.l(z,time);
 valPK(z,time,'NEAICM_CJK_NZ')         = PK.l(z,time);
 valPL(i,z,time,'NEAICM_CJK_NZ')       = PL.l(i,z,time);
 valPM(i,zj,z,time,'NEAICM_CJK_NZ')    = PM.l(i,zj,z,time);
 valPMT(i,z,time,'NEAICM_CJK_NZ')      = PMT.l(i,z,time);
 valPP(j,z,time,'NEAICM_CJK_NZ')       = PP.l(j,z,time);
 valPT(j,z,time,'NEAICM_CJK_NZ')       = PT.l(j,z,time);
 valPVA(j,Z,time,'NEAICM_CJK_NZ')      = PVA.l(j,Z,time);
 valPVAT(BS, Z_GRN,time,'NEAICM_CJK_NZ') = PVAT.l(BS, Z_GRN,time) ;  
 valPWM(i,zj,z,time,'NEAICM_CJK_NZ')   = PWM.l(i,zj,z,time);
 valPWMG(i,time,'NEAICM_CJK_NZ')       = PWMG.l(i,time);
 valPWX(i,z,zj,time,'NEAICM_CJK_NZ')   = PWX.l(i,z,zj,time);
 valQ(i,z,time,'NEAICM_CJK_NZ')        = Q.l(i,z,time);
 valR(k,j,z,time,'NEAICM_CJK_NZ')      = R.l(k,j,z,time);
 valRC(j,z,time,'NEAICM_CJK_NZ')       = RC.l(j,z,time);
 valRTI(k,j,z,time,'NEAICM_CJK_NZ')    = RTI.l(k,j,z,time);
 valSG(z,time,'NEAICM_CJK_NZ')         = SG.l(z,time);
 valSH(z,time,'NEAICM_CJK_NZ')         = SH.l(z,time);
 valsh0(z,time,'NEAICM_CJK_NZ')        = sh0.l(z,time);
 valsh1(z,time,'NEAICM_CJK_NZ')        = sh1.l(z,time);
 valSROW(z,time,'NEAICM_CJK_NZ')       = SROW.l(z,time);
 valTDH(z,time,'NEAICM_CJK_NZ')        = TDH.l(z,time);
 valTIC(i,z,time,'NEAICM_CJK_NZ')      = TIC.l(i,z,time);
 valTICT(z,time,'NEAICM_CJK_NZ')       = TICT.l(z,time);
 valTIK(k,j,z,time,'NEAICM_CJK_NZ')    = TIK.l(k,j,z,time);
 valTIKT(z,time,'NEAICM_CJK_NZ')       = TIKT.l(z,time);
 valTIM(i,zj,z,time,'NEAICM_CJK_NZ')   = TIM.l(i,zj,z,time);
 valTIMT(z,time,'NEAICM_CJK_NZ')       = TIMT.l(z,time);
 valTIP(j,z,time,'NEAICM_CJK_NZ')      = TIP.l(j,z,time);
 valTIPT(z,time,'NEAICM_CJK_NZ')       = TIPT.l(z,time);
 valTIW(j,z,time,'NEAICM_CJK_NZ')      = TIW.l(j,z,time);
 valTIWT(z,time,'NEAICM_CJK_NZ')       = TIWT.l(z,time);
 valTIX(i,z,zj,time,'NEAICM_CJK_NZ')   = TIX.l(i,z,zj,time);
 valTIXT(z,time,'NEAICM_CJK_NZ')       = TIXT.l(z,time);
 valTPRCTS(z,time,'NEAICM_CJK_NZ')     = TPRCTS.l(z,time);
 valTPRODN(z,time,'NEAICM_CJK_NZ')     = TPRODN.l(z,time);
 valttdh0(z,time,'NEAICM_CJK_NZ')      = ttdh0.l(z,time);
 valttdh1(z,time,'NEAICM_CJK_NZ')      = ttdh1.l(z,time);
 valttic(i,z,time,'NEAICM_CJK_NZ')     = ttic.l(i,z,time);
 valttik(k,j,z,time,'NEAICM_CJK_NZ')   = ttik.l(k,j,z,time);
 valttim(i,zj,z,time,'NEAICM_CJK_NZ')  = ttim.l(i,zj,z,time);
 valttip(j,z,time,'NEAICM_CJK_NZ')     = ttip.l(j,z,time);
 valttiw(j,z,time,'NEAICM_CJK_NZ')     = ttiw.l(j,z,time);
 valttix(i,z,zj,time,'NEAICM_CJK_NZ')  = ttix.l(i,z,zj,time);
 valU(z,time,'NEAICM_CJK_NZ')          = U.l(z,time);
 valVA(j,z,time,'NEAICM_CJK_NZ')       = VA.l(j,z,time);
 valKLE(j,z,time,'NEAICM_CJK_NZ')      = KLE.l(j,z,time);
 valW(z,time,'NEAICM_CJK_NZ')         = W.l(z,time);
 valWC(j,z,time,'NEAICM_CJK_NZ')      = WC.l(j,z,time);
 valWTI(j,z,time,'NEAICM_CJK_NZ')     = WTI.l(j,z,time);
 valXS(j,i,z,time,'NEAICM_CJK_NZ')    = XS.l(j,i,z,time);
 valXS_I(i,z,time,'NEAICM_CJK_NZ')    = XS_I.l(i,z,time);
 valXST(j,z,time,'NEAICM_CJK_NZ')     = XST.l(j,z,time);
 valYDH(z,time,'NEAICM_CJK_NZ')       = YDH.l(z,time);
 valYG(z,time,'NEAICM_CJK_NZ')        = YG.l(z,time);
 valYH(z,time,'NEAICM_CJK_NZ')        = YH.l(z,time);
 valYHK(z,time,'NEAICM_CJK_NZ')       = YHK.l(z,time);
 valYHL(z,time,'NEAICM_CJK_NZ')       = YHL.l(z,time);
 valYROW(z,time,'NEAICM_CJK_NZ')      = YROW.l(z,time);
 valYROW2(z,time,'NEAICM_CJK_NZ')     = -1*e.l(z,time)*SUM[(i,zj)$EXO(i,z,zj), EX.l(i,z,zj,time)*PWX.l(i,z,zj,time)] ;
 valYROW3(z,time,'NEAICM_CJK_NZ')     = -1*e.l(z,time)*SUM[i$MRGNO(i,z),MRGN.l(i,z,time)*PWMG.l(i,time)] ;
 valPERMIT_TOTAL(PERMIT_Z,time,'NEAICM_CJK_NZ') = PERMIT_TOTAL.l(PERMIT_Z,time);
 valPERMIT(j,z,time,'NEAICM_CJK_NZ')     = PERMIT.l(j,z,time);
 valCO2FACTOR(ene,j,z,time,'NEAICM_CJK_NZ') = CO2FACTOR2(ene,j,z,time);
 valLEON(z,time,'NEAICM_CJK_NZ') = LEON.l(z,time);
 valEndo_CO2(ene,j,z,time,'NEAICM_CJK_NZ')        = DE.L(ene,j,z,time)*CO2FACTOR2(ene,j,z,time)*10*1000;
 valEndo_TotalCO2(z,time,'NEAICM_CJK_NZ')         = sum((ene,j), valEndo_CO2(ene,j,z,time,'NEAICM_CJK_NZ'));
 valEndo_GlobalTotalCO2(time,'NEAICM_CJK_NZ')     = sum(z,valEndo_TotalCO2(z,time,'NEAICM_CJK_NZ'));
 valY_CTRAD(z,time,'NEAICM_CJK_NZ') = ((S3_EMISSIONS(z,time)/10000 - PERMIT_TOTAL.L(z,time))) * NEA_REGIONAL_CTAX.L(time);

*=================== Carbon Tax ============================================
 valCTAX(z,time,'NEAICM_CJK_NZ') = CTAX.L(z,time) ;
 valTCTAX(z,time,'NEAICM_CJK_NZ') = TCTAX.L(z,time) ;
 valNEA_REGIONAL_CTAX(time,'NEAICM_CJK_NZ') = NEA_REGIONAL_CTAX.L(time);
 
*==================== DAC================================================
 valQDAC(z,time,'NEAICM_CJK_NZ') = QDAC.l(z,time);
 valDAC_growth_rate(z,time,'NEAICM_CJK_NZ')  = DAC_growth_rate(z,time);
 valDAC_elec(z,time,'NEAICM_CJK_NZ') = QDAC.l(z,time)*DAC_Tech_Coeff('18_ELEC') ;
 valswitchDAC(z,time,'NEAICM_CJK_NZ') = switchDAC(z,time);

*================== Backstop ===============================================
 valVAT(BS,Z_GRN,time,'NEAICM_CJK_NZ') = VAT.L(BS,Z_GRN,time) ;
 valPVAT(BS,Z_GRN,time,'NEAICM_CJK_NZ')  = PVAT.L(BS,Z_GRN,time) ;
 valPTSF(BS,Z_GRN,time,'NEAICM_CJK_NZ')  = PTSF.L(BS,Z_GRN,time) ;
 valTSFD(BS,Z_GRN,time,'NEAICM_CJK_NZ') = TSFD.L(BS,Z_GRN,time) ;
 valTSFS(BS,Z_GRN,time,'NEAICM_CJK_NZ')  = TSFS(BS,Z_GRN,time) ;

*================== ToT ===========================================================
 valPX_INDEX(z,time,'NEAICM_CJK_NZ')     =  PX_INDEX.L(z,time)  ;                
 valPM_INDEX(z,time,'NEAICM_CJK_NZ')    =  PM_INDEX.L(z,time)  ;            
 valTOT(z,time,'NEAICM_CJK_NZ')             =  TOT.L(z,time)  ;
 
 execute_unload 'Output_CGE\S6_NEAICM_CJK_NZ.gdx',
 valA_VA,
 valC,
 valCAB,
 valCABX,
