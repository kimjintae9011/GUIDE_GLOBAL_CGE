...
IAMC(model_IAMC, 'BAU', Country, 'Secondary Energy|Electricity', 'EJ/yr', year_IAMC)                    = IAMC(model_IAMC, 'BAU', Country, 'Secondary Energy|Electricity|Biomass', 'EJ/yr', year_IAMC) 
                                                                                                        + IAMC(model_IAMC, 'BAU', Country, 'Secondary Energy|Electricity|Coal', 'EJ/yr', year_IAMC)   
                                                                                                        + IAMC(model_IAMC, 'BAU', Country, 'Secondary Energy|Electricity|Gas', 'EJ/yr', year_IAMC)   
                                                                                                        + IAMC(model_IAMC, 'BAU', Country, 'Secondary Energy|Electricity|Geothermal', 'EJ/yr', year_IAMC)
                                                                                                        + IAMC(model_IAMC, 'BAU', Country, 'Secondary Energy|Electricity|Hydro', 'EJ/yr', year_IAMC)  
                                                                                                        + IAMC(model_IAMC, 'BAU', Country, 'Secondary Energy|Electricity|Nuclear', 'EJ/yr', year_IAMC)  
                                                                                                        + IAMC(model_IAMC, 'BAU', Country, 'Secondary Energy|Electricity|Oil', 'EJ/yr', year_IAMC) 
                                                                                                        + IAMC(model_IAMC, 'BAU', Country, 'Secondary Energy|Electricity|Solar_PV', 'EJ/yr', year_IAMC) 
                                                                                                        + IAMC(model_IAMC, 'BAU', Country, 'Secondary Energy|Electricity|Wind', 'EJ/yr', year_IAMC)  ;
...
IAMC(model_IAMC, 'BAU', Country, 'Final Energy|Solids', 'EJ/yr', year_IAMC)                             = IAMC(model_IAMC, 'BAU', Country, 'Final Energy|Solids|Biomass', 'EJ/yr', year_IAMC) 
                                                                                                        + IAMC(model_IAMC, 'BAU', Country, 'Final Energy|Solids|Fossil', 'EJ/yr', year_IAMC)  ; 
...
IAMC(model_IAMC, 'BAU', Country, 'Final Energy', 'EJ/yr', year_IAMC)                                    = IAMC(model_IAMC, 'BAU', Country, 'Final Energy|Gases', 'EJ/yr', year_IAMC)
                                                                                                        + IAMC(model_IAMC, 'BAU', Country, 'Final Energy|Geothermal', 'EJ/yr', year_IAMC)
                                                                                                        + IAMC(model_IAMC, 'BAU', Country, 'Final Energy|Heat', 'EJ/yr', year_IAMC) 
                                                                                                        + IAMC(model_IAMC, 'BAU', Country, 'Final Energy|Electricity', 'EJ/yr', year_IAMC)
                                                                                                        + IAMC(model_IAMC, 'BAU', Country, 'Final Energy|Liquids', 'EJ/yr', year_IAMC)
                                                                                                        + IAMC(model_IAMC, 'BAU', Country, 'Final Energy|Solar', 'EJ/yr', year_IAMC)
                                                                                                        + IAMC(model_IAMC, 'BAU', Country, 'Final Energy|Solids', 'EJ/yr', year_IAMC)
                                                                                                        + IAMC(model_IAMC, 'BAU', Country, 'Final Energy|Hydrogen', 'EJ/yr', year_IAMC)  ;
...
execute_unload 'Output\Baseline_Results_GreenEcos',
 IAMC
