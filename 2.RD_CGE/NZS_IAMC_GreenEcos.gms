...
IAMC(model_IAMC, 'NZS', Country, 'Secondary Energy|Electricity|Oil', 'EJ/yr', year_IAMC)                = valElecGen('Oil',Country,year_IAMC,'NZS')*GWhtoEJ + eps;
...
execute_unload 'Output_w-t\NZS_Results_IAMC_GreenEcos',
 IAMC
