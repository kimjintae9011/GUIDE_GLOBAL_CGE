...
*==============================================================================
 ...
 valIND(j,z,time,'bau')    = IND.l(j,z,time);
 ...
 valKD(j,z,time,'bau')     = KD.l(j,z,time);
 valKDC(j,z,time,'bau')      = KDC.l(j,z,time);
 valKS(z,time,'bau')       = KS.l(z,time);
 ...
 valR(j,z,time,'bau')      = R.l(j,z,time);
 valRC(j,z,time,'bau')       = RC.l(j,z,time);
 valRTI(j,z,time,'bau')    = RTI.l(j,z,time);
 ...
 valTIK(j,z,time,'bau')    = TIK.l(j,z,time);
 ...
 valttik(j,z,time,'bau')   = ttik.l(j,z,time);
...
*$Ontext
 execute_unload 'Output_w-t\Baseline_Results_GTAP11c',
 valA_VA,
 valC,
 valCAB,
 valCABX,
