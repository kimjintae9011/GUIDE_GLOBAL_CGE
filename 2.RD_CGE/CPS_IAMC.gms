...
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Emissions|CO2|Energy', 'Mt CO2/yr', year_IAMC)                        = valTCO2(Country,year_IAMC,'CPS')/1000 ; 
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Emissions|CO2|Energy|Demand', 'Mt CO2/yr', year_IAMC)                 = [sum(Demand, valCO2I2(Demand,Country,year_IAMC,'CPS')+valCO2NE2(Demand,Country,year_IAMC,'CPS'))+valTCO2H(Country, year_IAMC,'CPS')]/1000 ; 
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Emissions|CO2|Energy|Demand|AFOFI', 'Mt CO2/yr', year_IAMC)           = valCO2I2('01_AGRICULT',Country,year_IAMC,'CPS')/1000 ; 
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Emissions|CO2|Energy|Demand|Commercial', 'Mt CO2/yr', year_IAMC)      = [valCO2I2('31_SER',Country,year_IAMC,'CPS')+valCO2NE2('31_SER',Country,year_IAMC,'CPS')]/1000 ;  
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Emissions|CO2|Energy|Demand|Industry', 'Mt CO2/yr', year_IAMC)        = sum(Industry2, valCO2I2(Industry2,Country,year_IAMC,'CPS')+valCO2NE2(Industry2,Country,year_IAMC,'CPS'))/1000 ;  ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Emissions|CO2|Energy|Demand|Other Sector', 'Mt CO2/yr', year_IAMC)    = eps ; 
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Emissions|CO2|Energy|Demand|Residential', 'Mt CO2/yr', year_IAMC)     = valTCO2H(Country, year_IAMC,'CPS')/1000 ; 
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Emissions|CO2|Energy|Demand|Transportation', 'Mt CO2/yr', year_IAMC)  = sum(Transportation, valCO2I2(Transportation,Country,year_IAMC,'CPS')+valCO2NE2(Transportation,Country,year_IAMC,'CPS'))/1000;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Emissions|CO2|Energy|Supply', 'Mt CO2/yr', year_IAMC)                 = sum(Supply, valCO2I2(Supply,Country,year_IAMC,'CPS')+valCO2NE2(Supply,Country,year_IAMC,'CPS'))/1000 ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Emissions|CO2|Energy|Supply|Electricity', 'Mt CO2/yr', year_IAMC)     = sum(Supply_elec, valCO2I2(Supply_elec,Country,year_IAMC,'CPS')+valCO2NE2(Supply_elec,Country,year_IAMC,'CPS'))/1000 ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Emissions|CO2|Energy|Supply|Gases', 'Mt CO2/yr', year_IAMC)           = [valCO2I2('04_GAS',Country,year_IAMC,'CPS')+valCO2NE2('04_GAS',Country,year_IAMC,'CPS')]/1000 ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Emissions|CO2|Energy|Supply|Heat', 'Mt CO2/yr', year_IAMC)            = eps; 
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Emissions|CO2|Energy|Supply|Liquids', 'Mt CO2/yr', year_IAMC)         = sum(Supply_liquid, valCO2I2(Supply_liquid,Country,year_IAMC,'CPS')+valCO2NE2(Supply_liquid,Country,year_IAMC,'CPS'))/1000 ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Emissions|CO2|Energy|Supply|Other Sector', 'Mt CO2/yr', year_IAMC)    = eps ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Emissions|CO2|Energy|Supply|Solids', 'Mt CO2/yr', year_IAMC)          = [valCO2I2('02_COAL',Country,year_IAMC,'CPS')+valCO2NE2('02_COAL',Country,year_IAMC,'CPS')]/1000 ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Emissions|CO2|Industrial Processes', 'Mt CO2/yr', year_IAMC)          = eps ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Emissions|CO2|AFOLU', 'Mt CO2/yr', year_IAMC)                         = eps ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Emissions|CO2|AFOLU|Land', 'Mt CO2/yr', year_IAMC)                    = eps ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Emissions|CO2|AFOLU|Land|Positive', 'Mt CO2/yr', year_IAMC)           = eps ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Emissions|CO2|AFOLU|Land|Negative', 'Mt CO2/yr', year_IAMC)           = eps ;

*Primary Energy (Direct equivalent method, Primary Energy Conumpiton)
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Primary Energy', 'EJ/yr', year_IAMC)                                  = valTES(Country,year_IAMC,'CPS')*ktoetoEJ + valElecGen('Bio',Country,year_IAMC,'CPS')*GWhtoEJ + valElecGen('Geothermal',Country,year_IAMC,'CPS')*GWhtoEJ + valElecGen('Hydro',Country,year_IAMC,'CPS')*GWhtoEJ + valElecGen('Nuclear',Country,year_IAMC,'CPS')*GWhtoEJ + valElecGen('Solar',Country,year_IAMC,'CPS')*GWhtoEJ + valElecGen('Wind',Country,year_IAMC,'CPS')*GWhtoEJ ; 
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Primary Energy|Biomass', 'EJ/yr', year_IAMC)                          = valElecGen('Bio',Country,year_IAMC,'CPS')*GWhtoEJ ; 
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Primary Energy|Coal', 'EJ/yr', year_IAMC)                             = valTES_coal(Country,year_IAMC,'CPS')*ktoetoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Primary Energy|Gas', 'EJ/yr', year_IAMC)                              = valTES_gas(Country,year_IAMC,'CPS')*ktoetoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Primary Energy|Geothermal', 'EJ/yr', year_IAMC)                       = valElecGen('Geothermal',Country,year_IAMC,'CPS')*GWhtoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Primary Energy|Hydro', 'EJ/yr', year_IAMC)                            = valElecGen('Hydro',Country,year_IAMC,'CPS')*GWhtoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Primary Energy|Nuclear', 'EJ/yr', year_IAMC)                          = valElecGen('Nuclear',Country,year_IAMC,'CPS')*GWhtoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Primary Energy|Oil', 'EJ/yr', year_IAMC)                              = valTES_oil(Country,year_IAMC,'CPS')*ktoetoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Primary Energy|Solar', 'EJ/yr', year_IAMC)                            = valElecGen('Solar',Country,year_IAMC,'CPS')*GWhtoEJ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Primary Energy|Wind', 'EJ/yr', year_IAMC)                             = valElecGen('Wind',Country,year_IAMC,'CPS')*GWhtoEJ;

*Secondary Energy (GWh to EJ)
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Secondary Energy|Electricity', 'EJ/yr', year_IAMC)                    = valElecGen('Total',Country,year_IAMC,'CPS')*GWhtoEJ ; 
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Secondary Energy|Electricity|Biomass|w/ CCS', 'EJ/yr', year_IAMC)     = eps ; 
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Secondary Energy|Electricity|Biomass|w/o CCS', 'EJ/yr', year_IAMC)    = valElecGen('Bio',Country,year_IAMC,'CPS')*GWhtoEJ ; 
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Secondary Energy|Electricity|Coal|w CCS', 'EJ/yr', year_IAMC)         = eps ;  
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Secondary Energy|Electricity|Coal|w/o CCS', 'EJ/yr', year_IAMC)       = valElecGen('Coal',Country,year_IAMC,'CPS')*GWhtoEJ ; 
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Secondary Energy|Electricity|Gas|w CCS', 'EJ/yr', year_IAMC)          = eps ; 
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Secondary Energy|Electricity|Gas|w/o CCS', 'EJ/yr', year_IAMC)        = valElecGen('Gas',Country,year_IAMC,'CPS')*GWhtoEJ ; 
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Secondary Energy|Electricity|Geothermal', 'EJ/yr', year_IAMC)         = valElecGen('Geothermal',Country,year_IAMC,'CPS')*GWhtoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Secondary Energy|Electricity|Hydro', 'EJ/yr', year_IAMC)              = valElecGen('Hydro',Country,year_IAMC,'CPS')*GWhtoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Secondary Energy|Electricity|Nuclear', 'EJ/yr', year_IAMC)            = valElecGen('Nuclear',Country,year_IAMC,'CPS')*GWhtoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Secondary Energy|Electricity|Oil|w/ CCS', 'EJ/yr', year_IAMC)         = eps ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Secondary Energy|Electricity|Oil|w/o CCS', 'EJ/yr', year_IAMC)        = valElecGen('Oil',Country,year_IAMC,'CPS')*GWhtoEJ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Secondary Energy|Electricity|Solar', 'EJ/yr', year_IAMC)              = valElecGen('Solar',Country,year_IAMC,'CPS')*GWhtoEJ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Secondary Energy|Electricity|Solar|CSP', 'EJ/yr', year_IAMC)          = eps ; 
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Secondary Energy|Electricity|Solar|PV', 'EJ/yr', year_IAMC)           = eps ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Secondary Energy|Electricity|Wind', 'EJ/yr', year_IAMC)               = valElecGen('Wind',Country,year_IAMC,'CPS')*GWhtoEJ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Secondary Energy|Electricity|Wind|Offshore', 'EJ/yr', year_IAMC)      = eps ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Secondary Energy|Electricity|Wind|Onshore', 'EJ/yr', year_IAMC)       = eps ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Secondary Energy|Hydrogen', 'EJ/yr', year_IAMC)                       = eps ; 

*Final Energy (ktoe to EJ)
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Final Energy', 'EJ/yr', year_IAMC)                                    = {sum(product, valEH(product,Country,year_IAMC,'CPS'))+Sum((product,Demand2),valEE(product,Demand2,Country,year_IAMC,'CPS'))+Sum((product,Demand2),valNE(product,Demand2,Country,year_IAMC,'CPS'))}*ktoetoEJ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Final Energy|Gases', 'EJ/yr', year_IAMC)                              = {sum(p_gas,valEH(p_gas,Country,year_IAMC,'CPS'))+ sum((p_gas, Demand2),valEE(p_gas,Demand2,Country,year_IAMC,'CPS'))}*ktoetoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Final Energy|Geothermal', 'EJ/yr', year_IAMC)                         = {eps}*ktoetoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Final Energy|Heat', 'EJ/yr', year_IAMC)                               = {valEH('p64_HEAT',Country,year_IAMC,'CPS')+ sum(Demand2,valEE('p64_HEAT',Demand2,Country,year_IAMC,'CPS'))}*ktoetoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Final Energy|Electricity', 'EJ/yr', year_IAMC)                        = {valEH('p63_ELECTR',Country,year_IAMC,'CPS')+ sum(Demand2,valEE('p63_ELECTR',Demand2,Country,year_IAMC,'CPS'))}*ktoetoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Final Energy|Hydrogen', 'EJ/yr', year_IAMC)                           = {eps}*ktoetoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Final Energy|Liquids', 'EJ/yr', year_IAMC)                            = {sum(p_liquids,valEH(p_liquids,Country,year_IAMC,'CPS'))+ sum((p_liquids, Demand2),valEE(p_liquids,Demand2,Country,year_IAMC,'CPS'))}*ktoetoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Final Energy|Solar', 'EJ/yr', year_IAMC)                              = {eps}*ktoetoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Final Energy|Solids', 'EJ/yr', year_IAMC)                             = {sum(p_coal,valEH(p_coal,Country,year_IAMC,'CPS'))+ sum((p_coal, Demand2),valEE(p_coal,Demand2,Country,year_IAMC,'CPS'))}*ktoetoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Final Energy|Solids|Biomass', 'EJ/yr', year_IAMC)                     = {eps}*ktoetoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Final Energy|Solids|Coal', 'EJ/yr', year_IAMC)                        = {sum(p_coal,valEH(p_coal,Country,year_IAMC,'CPS'))+ sum((p_coal, Demand2),valEE(p_coal,Demand2,Country,year_IAMC,'CPS'))}*ktoetoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Final Energy|Industry', 'EJ/yr', year_IAMC)                           = {sum((product,Industry2),valEE(product,Industry2,Country,year_IAMC,'CPS'))}*ktoetoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Final Energy|Non-Energy Use', 'EJ/yr', year_IAMC)                     = {sum((product,j),valNE(product,j,Country,year_IAMC,'CPS'))}*ktoetoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Final Energy|Residential', 'EJ/yr', year_IAMC)                        = {sum(product,valEH(product,Country,year_IAMC,'CPS'))}*ktoetoEJ ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Final Energy|Commercial', 'EJ/yr', year_IAMC)                         = {sum((product,Service2),valEE(product,Service2,Country,year_IAMC,'CPS'))}*ktoetoEJ ; 
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Final Energy|Transportation', 'EJ/yr', year_IAMC)                     = {sum((product,Transportation),valEE(product,Transportation,Country,year_IAMC,'CPS'))}*ktoetoEJ ;

*Agricultural Production
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Agricultural Production|Energy', 'million t DM/yr', year_IAMC)            = eps ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Agricultural Production|Energy|Crops', 'million t DM/yr', year_IAMC)      = eps ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Agricultural Production|Non-Energy', 'million t DM/yr', year_IAMC)        = eps ;

*Fertilizer Use
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Fertilizer Use|Nitrogen', 'Tg N/yr', year_IAMC)                           = eps ;

*Land Cover
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Land Cover', 'Tg N/yr', year_IAMC)                                        = eps ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Land Cover|Built-up Area', 'Tg N/yr', year_IAMC)                          = eps ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Land Cover|Cropland', 'Tg N/yr', year_IAMC)                               = eps ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Land Cover|Forest', 'Tg N/yr', year_IAMC)                                 = eps ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Land Cover|Forest|Afforestation and Reforestation', 'Tg N/yr', year_IAMC) = eps ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Land Cover|Forest|Natural Forest', 'Tg N/yr', year_IAMC)                  = eps ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Land Cover|Other Arable Land', 'Tg N/yr', year_IAMC)                      = eps ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Land Cover|Other Land', 'Tg N/yr', year_IAMC)                             = eps ;
IAMC('Tier1', 'GUIDE', Country, 'CPS', 'Land Cover|Pasture', 'Tg N/yr', year_IAMC)                                = eps ;
