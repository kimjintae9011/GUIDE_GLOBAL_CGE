...
*=============================== Energy =====================================================================
 ...
 valTFC_product(product,time,z,'bau')   = valEH(product,z,time,'bau') + Sum(j5,valEE(product,j5,z,time,'bau'))+Sum(j,valNE(product,j,z,time,'bau'));
...
*$Ontext
 execute_unload 'Output_w-t\Baseline_Results_GTAP11',
 valA_VA,
 valC,
 valCAB,
 valCABX,
