...
Start_Year(i3,'02_CHN') = 12;
Start_Year(i3,'03_JPN') = 12;
Start_Year(i3,'04_RUS') = 22;
Start_Year(i3,'05_MNG') = 22;
Start_Year(i3,'06_PRK') = 33;
Start_Year(i3,'07_NAM') = 7;
Start_Year(i3,'08_LAM') = 22;
Start_Year(i3,'09_WEU') = 7; 
Start_Year(i3,'10_EEU') = 7;
Start_Year(i3,'11_FSU') = 22;
Start_Year(i3,'12_MEA') = 22;
Start_Year(i3,'13_AFR') = 22;
Start_Year(i3,'14_CPA') = 22;
Start_Year(i3,'15_SAS') = 22;
Start_Year(i3,'16_PAS') = 22;
Start_Year(i3,'17_PAO') = 12;
