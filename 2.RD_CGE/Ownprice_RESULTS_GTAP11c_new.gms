...
*============================= Backstop technology =========================================================
 valswitch(i3,z,time,'bau') = switch(i3,z,time) ;
 valpenetration_rate(i3,z,time,'bau') = penetration_rate(i3,z,time) ;  
 valC_Conventional(i3,z,time,'bau') = C_Conventional.l(i3,z,time) ;
 valXDBS(i3,z,time,'bau')  = XDBS.l(i3,z,time) ;
 valXDBS2(j,z,time,'bau')  = XDBS2.l(j,z,time) ; 
 valLBS(j,z,time,'bau')  = LBS.l(j,z,time) ;
 valKBS(k,j,z,time,'bau')  = KBS.l(k,j,z,time) ;
 valCLBS(i3,z,time,'bau')  = CLBS.l(i3,z,time) ;
 valCKBS(i3,z,time,'bau')  = CKBS.l(i3,z,time) ;
...
*$Ontext
 execute_unload 'Output_CGE\Ownprice_Results_GTAP11c_new',
 valA_VA,
 valC,
 valCAB,
 valCABX,
