...
*==============================================================================
 ...
 PIRONSTL.L(Z_GRN,t1)             = PIRONSTLO(Z_GRN);
 PI.l(i,z,t1)               = PO(i,z);
 PT.L(j,z,t1)               = PTO(j,z);
 PP.L(j,z,t1)               = PPO(j,z);
 PC.L(i,z,t1)               = PCO(i,z);
 ...
 PTSF.L(Z_GRN,t1)       = PTSFO(Z_GRN);
 PVAT.L(Z_GRN, t1)    = PVATO(Z_GRN);
...
* ttik_lag.L(j,z,t1)         = ttikO('cap',j,z);
* TIK_Share.L(j,z,t1)        = TIKO_Share('cap',j,z);
* deltatip.L(j,z,t1)         = 0;
* ttip.L(j,z,t1)             = ttipO(j,z);
* ttip_lag.L(j,z,t1)         = ttipO(j,z);
* TIP_Share.L(j,z,t1)        = TIPO_Share(j,z);
...
*==============================================================================
 ...
 IRONSTLQ.L(Z_GRN,time)           = IRONSTLQ.L(Z_GRN,time-1);
 ...
 TSFD.L(j,Z_GRN,time) = TSFD.L(j,Z_GRN,time-1) ;
 VAT.L(Z_GRN, time)  = VAT.L(Z_GRN,time-1);
...
*==============================================================================
 ...
 PIRONSTL.L(Z_GRN,time)           = PIRONSTL.L(Z_GRN,time-1);
 ...
 PTSF.L(Z_GRN,time)     = PTSF.L(Z_GRN,time-1);
 PVAT.L(Z_GRN,time)    = PVAT.L(Z_GRN,time-1);
...
* ttik_lag.L(j,z,time)       = ttik_lag.L(j,z,time-1);
* TIK_Share.L(j,z,time)      = TIK_Share.L(j,z,time-1);
* deltatip.L(j,z,time)       = deltatip.L(j,z,time-1);
* ttip.L(j,z,time)           = ttip.L(j,z,time-1);
* ttip_lag.L(j,z,time)       = ttip_lag.L(j,z,time-1);
