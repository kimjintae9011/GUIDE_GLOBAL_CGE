...
S3_EMISSIONS(z,time)
;
$CALL gdxxrw Input_CGE\S2_EMISSIONS.xlsx par=S3_EMISSIONS rng=S3_EMISSIONS!A1 Rdim=1 Cdim=1 output=Input_CGE\S3_EMISSIONS.gdx
...
S4_PERMIT(time)
;
$CALL gdxxrw Input_CGE\S4_PERMIT.xlsx par=S4_PERMIT rng=S4_PERMIT!A1 Rdim=1 output=Input_CGE\S4_PERMIT.gdx
$GDXIN Input_CGE\S4_PERMIT.gdx
$LOAD S4_PERMIT
...
*==============================================================================
 ...
 EQ_NEA_Cap(t).. 
    SUM(NEA, PERMIT_TOTAL(NEA, t)) =e= S4_PERMIT(t)/10000;
...
/
NEAICM_ALL_NZ      NEA Integrated Carbon Market_Net Zero
/
;
...
*==============================================================================
$INCLUDE NEAICM_ALL_NZ_SOLVE.gms
$INCLUDE NEAICM_ALL_NZ_RESULTS.gms
