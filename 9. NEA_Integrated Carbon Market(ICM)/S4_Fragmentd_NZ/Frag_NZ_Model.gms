...
S3_PERMIT(z,time)
;
$CALL gdxxrw Input_CGE\S3_PERMIT.xlsx par=S3_PERMIT rng=S3_PERMIT!A1 Rdim=1 Cdim=1 output=Input_CGE\S3_PERMIT.gdx
$GDXIN Input_CGE\S3_PERMIT.gdx
$LOAD S3_PERMIT 
...
*==============================================================================
$INCLUDE Frag_NZ_SOLVE.gms
$INCLUDE Frag_NZ_RESULTS.gms
