...
*==============================================================================
 valA_VA(z,time,'Frag_NZ')       = A_VA.l(z,time);
 valC(i,z,time,'Frag_NZ')        = C.l(i,z,time);
 valCAB(z,time,'Frag_NZ')        = CAB.l(z,time);
 valCABX(z,time,'Frag_NZ')       = CABX.l(z,time);
 valCG(i,z,time,'Frag_NZ')       = CG.l(i,z,time);
 valCI(j,z,time,'Frag_NZ')       = CI.l(j,z,time);
 valCE(j,z,time,'Frag_NZ')       = CE.l(j,z,time);
 valCMIN(i,z,time,'Frag_NZ')     = CMIN.l(i,z,time);
 valCTH(z,time,'Frag_NZ')        = CTH.l(z,time);
 valCTH_REAL(z,time,'Frag_NZ')   = CTH_REAL.l(z,time);
 valDD(i,z,time,'Frag_NZ')       = DD.l(i,z,time);
 valDEP(z,time,'Frag_NZ')        = DEP.l(z,time);
 valDI(i,j,z,time,'Frag_NZ')     = DI.l(i,j,z,time);
 valDE(i,j,z,time,'Frag_NZ')     = DE.l(i,j,z,time);
 valDIT(i,z,time,'Frag_NZ')      = DIT.l(i,z,time);
 valDS(j,i,z,time,'Frag_NZ')     = DS.l(j,i,z,time);
 valDS_I(i,z,time,'Frag_NZ')     = DS_I.l(i,z,time);
 vale(z,time,'Frag_NZ')          = e.l(z,time);
 valEX(i,z,zj,time,'Frag_NZ')    = EX.l(i,z,zj,time);
 valEXT(i,z,time,'Frag_NZ')      = EXT.l(i,z,time);
 valG(z,time,'Frag_NZ')          = G.l(z,time);
 ValG_REAL(z,time,'Frag_NZ')     = G_REAL.L(z,time);
 valGDP_BP(z,time,'Frag_NZ')     = GDP_BP.l(z,time);
 valGDP_BP_REAL(z,time,'Frag_NZ')= GDP_BP_REAL.l(z,time);
 valGDP_BP_W(time,'Frag_NZ')     = GDP_BP_W.l(time);
 valGDP_BP_W_REAL(time,'Frag_NZ')= GDP_BP_W_REAL.l(time);
 valGDP_FD(z,time,'Frag_NZ')     = GDP_FD.l(z,time);
 valGDP_IB(z,time,'Frag_NZ')     = GDP_IB.l(z,time);
 valGDP_MP(z,time,'Frag_NZ')     = GDP_MP.l(z,time);
 valGDP_MP_REAL(z,time,'Frag_NZ')= GDP_MP_REAL.l(z,time);
 valIM(i,zj,z,time,'Frag_NZ')    = IM.l(i,zj,z,time);
 valIMT(i,z,time,'Frag_NZ')      = IMT.l(i,z,time);
 valIND(k,j,z,time,'Frag_NZ')    = IND.l(k,j,z,time);
 valINV(i,z,time,'Frag_NZ')      = INV.l(i,z,time);
 valIR(z,time,'Frag_NZ')         = IR.l(z,time);
 valIT(z,time,'Frag_NZ')         = IT.l(z,time);
 valIT_REAL(z,time,'Frag_NZ')    = IT_REAL.l(z,time);
 valKD(k,j,z,time,'Frag_NZ')     = KD.l(k,j,z,time);
 valKDC(j,z,time,'Frag_NZ')      = KDC.l(j,z,time);
 valKS(k,z,time,'Frag_NZ')       = KS.l(k,z,time);
 valLD(j,z,time,'Frag_NZ')       = LD.l(j,z,time);
 valLDC(j,z,time,'Frag_NZ')      = LDC.l(j,z,time);
 valLS(z,time,'Frag_NZ')         = LS.l(z,time);
 valLST(z,time,'Frag_NZ')        = LST.l(z,time);
 valMRGN(i,z,time,'Frag_NZ')     = MRGN.l(i,z,time);
 valP(i,z,time,'Frag_NZ')        = P.l(i,z,time);
 valPC(i,z,time,'Frag_NZ')       = PC.l(i,z,time);
 valPCI(j,z,time,'Frag_NZ')      = PCI.l(j,z,time);
 valPCE(j,z,time,'Frag_NZ')      = PCE.l(j,z,time);
 valPD(i,z,time,'Frag_NZ')       = PD.l(i,z,time);
 valPE(i,z,zj,time,'Frag_NZ')    = PE.l(i,z,zj,time);
 valPET(i,z,time,'Frag_NZ')      = PET.l(i,z,time);
 valphi(z,time,'Frag_NZ')        = phi.l(z,time);
 valPIXCON(z,time,'Frag_NZ')     = PIXCON.l(z,time);
 valPIXGDP(z,time,'Frag_NZ')     = PIXGDP.l(z,time);
 valPIXGDP_W(time,'Frag_NZ')     = PIXGDP_W.l(time);
 valPIXGVT(z,time,'Frag_NZ')     = PIXGVT.l(z,time);
 valPIXINV(z,time,'Frag_NZ')     = PIXINV.l(z,time);
 valPK(z,time,'Frag_NZ')         = PK.l(z,time);
 valPL(i,z,time,'Frag_NZ')       = PL.l(i,z,time);
 valPM(i,zj,z,time,'Frag_NZ')    = PM.l(i,zj,z,time);
 valPMT(i,z,time,'Frag_NZ')      = PMT.l(i,z,time);
 valPP(j,z,time,'Frag_NZ')       = PP.l(j,z,time);
 valPT(j,z,time,'Frag_NZ')       = PT.l(j,z,time);
 valPVA(j,Z,time,'Frag_NZ')      = PVA.l(j,Z,time);
 valPVAT(BS, Z_GRN,time,'Frag_NZ') = PVAT.l(BS, Z_GRN,time) ;  
 valPWM(i,zj,z,time,'Frag_NZ')   = PWM.l(i,zj,z,time);
 valPWMG(i,time,'Frag_NZ')       = PWMG.l(i,time);
 valPWX(i,z,zj,time,'Frag_NZ')   = PWX.l(i,z,zj,time);
 valQ(i,z,time,'Frag_NZ')        = Q.l(i,z,time);
 valR(k,j,z,time,'Frag_NZ')      = R.l(k,j,z,time);
 valRC(j,z,time,'Frag_NZ')       = RC.l(j,z,time);
 valRTI(k,j,z,time,'Frag_NZ')    = RTI.l(k,j,z,time);
 valSG(z,time,'Frag_NZ')         = SG.l(z,time);
 valSH(z,time,'Frag_NZ')         = SH.l(z,time);
 valsh0(z,time,'Frag_NZ')        = sh0.l(z,time);
 valsh1(z,time,'Frag_NZ')        = sh1.l(z,time);
 valSROW(z,time,'Frag_NZ')       = SROW.l(z,time);
 valTDH(z,time,'Frag_NZ')        = TDH.l(z,time);
 valTIC(i,z,time,'Frag_NZ')      = TIC.l(i,z,time);
 valTICT(z,time,'Frag_NZ')       = TICT.l(z,time);
 valTIK(k,j,z,time,'Frag_NZ')    = TIK.l(k,j,z,time);
 valTIKT(z,time,'Frag_NZ')       = TIKT.l(z,time);
 valTIM(i,zj,z,time,'Frag_NZ')   = TIM.l(i,zj,z,time);
 valTIMT(z,time,'Frag_NZ')       = TIMT.l(z,time);
 valTIP(j,z,time,'Frag_NZ')      = TIP.l(j,z,time);
 valTIPT(z,time,'Frag_NZ')       = TIPT.l(z,time);
 valTIW(j,z,time,'Frag_NZ')      = TIW.l(j,z,time);
 valTIWT(z,time,'Frag_NZ')       = TIWT.l(z,time);
 valTIX(i,z,zj,time,'Frag_NZ')   = TIX.l(i,z,zj,time);
 valTIXT(z,time,'Frag_NZ')       = TIXT.l(z,time);
 valTPRCTS(z,time,'Frag_NZ')     = TPRCTS.l(z,time);
 valTPRODN(z,time,'Frag_NZ')     = TPRODN.l(z,time);
 valttdh0(z,time,'Frag_NZ')      = ttdh0.l(z,time);
 valttdh1(z,time,'Frag_NZ')      = ttdh1.l(z,time);
 valttic(i,z,time,'Frag_NZ')     = ttic.l(i,z,time);
 valttik(k,j,z,time,'Frag_NZ')   = ttik.l(k,j,z,time);
 valttim(i,zj,z,time,'Frag_NZ')  = ttim.l(i,zj,z,time);
 valttip(j,z,time,'Frag_NZ')     = ttip.l(j,z,time);
 valttiw(j,z,time,'Frag_NZ')     = ttiw.l(j,z,time);
 valttix(i,z,zj,time,'Frag_NZ')  = ttix.l(i,z,zj,time);
 valU(z,time,'Frag_NZ')          = U.l(z,time);
 valVA(j,z,time,'Frag_NZ')       = VA.l(j,z,time);
 valKLE(j,z,time,'Frag_NZ')      = KLE.l(j,z,time);
 valW(z,time,'Frag_NZ')         = W.l(z,time);
 valWC(j,z,time,'Frag_NZ')      = WC.l(j,z,time);
 valWTI(j,z,time,'Frag_NZ')     = WTI.l(j,z,time);
 valXS(j,i,z,time,'Frag_NZ')    = XS.l(j,i,z,time);
 valXS_I(i,z,time,'Frag_NZ')    = XS_I.l(i,z,time);
 valXST(j,z,time,'Frag_NZ')     = XST.l(j,z,time);
 valYDH(z,time,'Frag_NZ')       = YDH.l(z,time);
 valYG(z,time,'Frag_NZ')        = YG.l(z,time);
 valYH(z,time,'Frag_NZ')        = YH.l(z,time);
 valYHK(z,time,'Frag_NZ')       = YHK.l(z,time);
 valYHL(z,time,'Frag_NZ')       = YHL.l(z,time);
 valYROW(z,time,'Frag_NZ')      = YROW.l(z,time);
 valYROW2(z,time,'Frag_NZ')     = -1*e.l(z,time)*SUM[(i,zj)$EXO(i,z,zj), EX.l(i,z,zj,time)*PWX.l(i,z,zj,time)] ;
 valYROW3(z,time,'Frag_NZ')     = -1*e.l(z,time)*SUM[i$MRGNO(i,z),MRGN.l(i,z,time)*PWMG.l(i,time)] ;
 valPERMIT_TOTAL(PERMIT_Z,time,'Frag_NZ') = PERMIT_TOTAL.l(PERMIT_Z,time);
 valPERMIT(j,z,time,'Frag_NZ')     = PERMIT.l(j,z,time);
 valCO2FACTOR(ene,j,z,time,'Frag_NZ') = CO2FACTOR2(ene,j,z,time);
 valLEON(z,time,'Frag_NZ') = LEON.l(z,time);
 valEndo_CO2(ene,j,z,time,'Frag_NZ')        = DE.L(ene,j,z,time)*CO2FACTOR2(ene,j,z,time)*10*1000;
 valEndo_TotalCO2(z,time,'Frag_NZ')         = sum((ene,j), valEndo_CO2(ene,j,z,time,'Frag_NZ'));
 valEndo_GlobalTotalCO2(time,'Frag_NZ')     = sum(z,valEndo_TotalCO2(z,time,'Frag_NZ'));

*=================== Carbon Tax ============================================
 valCTAX(z,time,'Frag_NZ') = CTAX.l(z,time) ;
 valTCTAX(z,time,'Frag_NZ') = TCTAX.l(z,time) ;

*==================== DAC================================================
 valQDAC(z,time,'Frag_NZ') = QDAC.l(z,time);
 valDAC_growth_rate(z,time,'Frag_NZ')  = DAC_growth_rate(z,time);
 valDAC_elec(z,time,'Frag_NZ') = QDAC.l(z,time)*DAC_Tech_Coeff('18_ELEC') ;
 valswitchDAC(z,time,'Frag_NZ') = switchDAC(z,time);

*================== Backstop ===============================================
 valVAT(BS,Z_GRN,time,'Frag_NZ') = VAT.L(BS,Z_GRN,time) ;
 valPVAT(BS,Z_GRN,time,'Frag_NZ')  = PVAT.L(BS,Z_GRN,time) ;
 valPTSF(BS,Z_GRN,time,'Frag_NZ')  = PTSF.L(BS,Z_GRN,time) ;
 valTSFD(BS,Z_GRN,time,'Frag_NZ') = TSFD.L(BS,Z_GRN,time) ;
 valTSFS(BS,Z_GRN,time,'Frag_NZ')  = TSFS(BS,Z_GRN,time) ;

*================== ToT ===========================================================
 valPX_INDEX(z,time,'Frag_NZ')     =  PX_INDEX.L(z,time)  ;                
 valPM_INDEX(z,time,'Frag_NZ')    =  PM_INDEX.L(z,time)  ;            
 valTOT(z,time,'Frag_NZ')             =  TOT.L(z,time)  ;
 
 execute_unload 'Output_CGE\S4_Frag_NZ.gdx',
 valA_VA,
 valC,
 valCAB,
 valCABX,
