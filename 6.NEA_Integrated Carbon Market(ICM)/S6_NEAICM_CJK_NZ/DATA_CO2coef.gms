...
;
 ...
 EEI(p_waste,j,z)$XSTO(j,z)                                        = Waste_DIO(p_waste,j,z)/XSTO(j,z);
 EEI(p_bio,j,z)$XSTO(j,z)                                          = Bio_DIO(p_bio,j,z)/XSTO(j,z);
 EEI(p_charcoal,j,z)$XSTO(j,z)                                     = Charcoal_DIO(p_charcoal,j,z)/XSTO(j,z);
 EEI(p_solar,j,z)$XSTO(j,z)                                        = Solar_DIO(p_solar,j,z)/XSTO(j,z);
 EEI(p_geo,j,z) $XSTO(j,z)                                         = Geo_DIO(p_geo,j,z)/XSTO(j,z);  
