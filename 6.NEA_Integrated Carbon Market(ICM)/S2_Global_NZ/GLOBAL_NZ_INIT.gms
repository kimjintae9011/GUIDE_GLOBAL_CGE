...
*==============================================================================
 ...
 CTAX.L(z,t1)                   = CTAXO(z);
 Global_CTAX.l(t1)           = Global_CTAXO;       
 OBJ.L                          = OBJO;
 TSFD.L(BS,Z_GRN,t1)            = TSFO(BS,Z_GRN);
 VAT.L(BS,Z_GRN,t1)             = VATO(BS,Z_GRN);
 QDAC.L(z,t1) = 0;
 REVENUE_SHARE_VAR.L(z,t1) =REVENUE_SHARE_VARO(z);   
 NEW_PERMIT_CAP_VAR.L(z,t1)= NEW_PERMIT_CAP_VARO(z);  
...
*==============================================================================
    ...
    REVENUE_SHARE_VAR.L(z,time) = REVENUE_SHARE_VAR.L(z,time-1) ;   
    NEW_PERMIT_CAP_VAR.L(z,time)=NEW_PERMIT_CAP_VAR.L(z,time-1);  
