...
my_flows = [
    ...
    'f98_NE_OTHER','f99_ELOUTPUT', 'f100_ELMAINE', 'f101_ELAOUTOE', 'f102_ELMAINC', 'f103_ELAUTOC','f104_HEATOUT', 'f105_HEMAINC', 'f106_HEAUTOC', 'f107_HEMAINH', 'f108_HEAUTOH'
]
...
all_regions = ['01_KOR', '02_CHN', '03_JPN', '04_RUS', '05_MNG', '06_PRK', '07_NAM', '08_LAM', '09_WEU',
               '10_EEU', '11_CAS', '12_MEA', '13_AFR', '14_CLV', '15_SAS', '16_APC', '17_ANZ']
...
print(f"총 행 수: {len(final_df)}행 (18개 지역 x 98개 Flow x 67개 Product)")
...
# 5) 엑셀 결과 리포트
# =====================================================================
output_filename = "260425_WEB19.xlsx"
...
fig.update_layout(
    title="<b>동북아 6개국 최종에너지소비(TFC) 트렌드 (1990-2023)</b><br><sup>오른쪽 범례(Legend)의 국가명을 클릭하면 해당 국가를 켜고 끌 수 있습니다.</sup>",
    xaxis_title="연도 (Year)",
