...
* CTAX and PERMIT
*============================================================================== 
    PERMIT_TOTAL.fx(PERMIT_Z,time)$[ord(time) gt 1] = PERMIT_TOTALO(PERMIT_Z) * PERMIT_NDC(PERMIT_Z,time);  
...
*=============================================================================
    B_VA_t('18_TnD',z,time)$[ord(time) gt 1]    = B_VA_t('18_TnD',z,time-1) * [1 + SolarWind_TFP_NDC];
    B_VA_t('23_eWind',z,time)$[ord(time) gt 1]  = B_VA_t('23_eWind',z,time-1) * [1 + SolarWind_TFP_NDC];
    B_VA_t('24_eSolar',z,time)$[ord(time) gt 1] = B_VA_t('24_eSolar',z,time-1) * [1 + SolarWind_TFP_NDC];
*=============================================================================
...
* Before 2040: Maintain existing intensity
