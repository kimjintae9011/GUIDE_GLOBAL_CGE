...
IAMC(model_IAMC, '%CurrentSce%', Country,  'GDP|MER', 'billion USD_2010/yr', year_IAMC)                          = valGDP_MP_REAL(Country, year_IAMC,'%CurrentSce%')*USD2019toUSD2010 + eps ; 

*Value Added|Agriculture 10$billion$ to billion$ (Nonimal, 10billion to billion)
IAMC(model_IAMC, '%CurrentSce%', Country,  'Value Added|Agriculture', 'billion USD_2010/yr', year_IAMC)      = sum(Agriculture, valPVA(Agriculture, Country, year_IAMC,'%CurrentSce%')*valVA(Agriculture, Country, year_IAMC,'%CurrentSce%'))/valPIXGDP(Country, year_IAMC,'%CurrentSce%')*USD2019toUSD2010 + eps ; 
...
*=====================================================================================================================
* Emissions|CO2 (kt to Mt : multiply by 0.001)
*=====================================================================================================================
*Emissions|CO2 (kt to Mt)
IAMC(model_IAMC, '%CurrentSce%', Country, 'Emissions|CO2|Energy', 'Mt CO2/yr', year_IAMC)                                     =  valTCO2(Country,year_IAMC,'%CurrentSce%')*ktoMt  + eps ; 
IAMC(model_IAMC, '%CurrentSce%', Country, 'Emissions|CO2|Energy|Demand', 'Mt CO2/yr', year_IAMC)                        = [sum(Demand, valCO2I2(Demand,Country,year_IAMC,'%CurrentSce%')+valCO2NE2(Demand,Country,year_IAMC,'%CurrentSce%'))+valTCO2H(Country, year_IAMC,'%CurrentSce%')]* ktoMt+ eps ; 
IAMC(model_IAMC, '%CurrentSce%', Country, 'Emissions|CO2|Energy|Demand|AFOFI', 'Mt CO2/yr', year_IAMC)              = valCO2I2('01_AGRICULT',Country,year_IAMC,'%CurrentSce%')*ktoMt + eps ; 
IAMC(model_IAMC, '%CurrentSce%', Country, 'Emissions|CO2|Energy|Demand|Commercial', 'Mt CO2/yr', year_IAMC)      = [valCO2I2('31_SER',Country,year_IAMC,'%CurrentSce%')+valCO2NE2('31_SER',Country,year_IAMC,'%CurrentSce%')]*ktoMt + eps ;  
IAMC(model_IAMC, '%CurrentSce%', Country, 'Emissions|CO2|Energy|Demand|Industry', 'Mt CO2/yr', year_IAMC)           = sum(Industry2, valCO2I2(Industry2,Country,year_IAMC,'%CurrentSce%')+valCO2NE2(Industry2,Country,year_IAMC,'%CurrentSce%'))*ktoMt + eps ;
IAMC(model_IAMC, '%CurrentSce%', Country, 'Emissions|CO2|Energy|Demand|Other Sector', 'Mt CO2/yr', year_IAMC)    = eps ; 
IAMC(model_IAMC, '%CurrentSce%', Country, 'Emissions|CO2|Energy|Demand|Residential', 'Mt CO2/yr', year_IAMC)       = valTCO2H(Country, year_IAMC,'%CurrentSce%')*ktoMt + eps ; 
IAMC(model_IAMC, '%CurrentSce%', Country, 'Emissions|CO2|Energy|Demand|Transportation', 'Mt CO2/yr', year_IAMC)  = sum(Transportation, valCO2I2(Transportation,Country,year_IAMC,'%CurrentSce%')+valCO2NE2(Transportation,Country,year_IAMC,'%CurrentSce%'))*ktoMt + eps;
IAMC(model_IAMC, '%CurrentSce%', Country, 'Emissions|CO2|Energy|Supply', 'Mt CO2/yr', year_IAMC)                            = sum(Supply, valCO2I2(Supply,Country,year_IAMC,'%CurrentSce%')+valCO2NE2(Supply,Country,year_IAMC,'%CurrentSce%'))*ktoMt + eps ;
IAMC(model_IAMC, '%CurrentSce%', Country, 'Emissions|CO2|Energy|Supply|Electricity', 'Mt CO2/yr', year_IAMC)            = sum(Supply_elec, valCO2I2(Supply_elec,Country,year_IAMC,'%CurrentSce%')+valCO2NE2(Supply_elec,Country,year_IAMC,'%CurrentSce%'))*ktoMt + eps ;
IAMC(model_IAMC, '%CurrentSce%', Country, 'Emissions|CO2|Energy|Supply|Gases', 'Mt CO2/yr', year_IAMC)                  = [valCO2I2('04_GAS',Country,year_IAMC,'%CurrentSce%')+valCO2NE2('04_GAS',Country,year_IAMC,'%CurrentSce%')]*ktoMt + eps;
IAMC(model_IAMC, '%CurrentSce%', Country, 'Emissions|CO2|Energy|Supply|Heat', 'Mt CO2/yr', year_IAMC)                   = eps; 
IAMC(model_IAMC, '%CurrentSce%', Country, 'Emissions|CO2|Energy|Supply|Liquids', 'Mt CO2/yr', year_IAMC)                = sum(Supply_liquid, valCO2I2(Supply_liquid,Country,year_IAMC,'%CurrentSce%')+valCO2NE2(Supply_liquid,Country,year_IAMC,'%CurrentSce%'))*ktoMt + eps ;
IAMC(model_IAMC, '%CurrentSce%', Country, 'Emissions|CO2|Energy|Supply|Other', 'Mt CO2/yr', year_IAMC)                  = eps ;
IAMC(model_IAMC, '%CurrentSce%', Country, 'Emissions|CO2|Energy|Supply|Solids', 'Mt CO2/yr', year_IAMC)                 = [valCO2I2('02_COAL',Country,year_IAMC,'%CurrentSce%')+valCO2NE2('02_COAL',Country,year_IAMC,'%CurrentSce%')]*ktoMt + eps ;
...
IAMC(model_IAMC, '%CurrentSce%', Country, 'Emissions|CO2', 'Mt CO2/yr', year_IAMC)                                                 = valTCO2(Country,year_IAMC,'%CurrentSce%')*ktoMt + eps ; 

*=====================================================================================================================
* Primary Energy (ktoe to EJ)
*=====================================================================================================================
...
*=====================================================================================================================
* Final Energy (ktoe to EJ) - Perfectly aligned with End-Use f_* sets
*=====================================================================================================================
...
IAMC(model_IAMC, '%CurrentSce%', Country, 'Final Energy|Heat', 'EJ/yr', year_IAMC)                               = {valEH('p67_HEAT',Country,year_IAMC,'%CurrentSce%')+ sum(Demand2,valEE('p67_HEAT',Demand2,Country,year_IAMC,'%CurrentSce%'))}*ktoetoEJ + eps ;
IAMC(model_IAMC, '%CurrentSce%', Country, 'Final Energy|Electricity', 'EJ/yr', year_IAMC)                        = {valEH('p66_ELECTRICITY',Country,year_IAMC,'%CurrentSce%')+ sum(Demand2,valEE('p66_ELECTRICITY',Demand2,Country,year_IAMC,'%CurrentSce%'))}*ktoetoEJ + eps ;
