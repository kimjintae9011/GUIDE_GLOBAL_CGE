...
# 차트 출력
plot_grid(full_abs, 'GDP_Absolute', 'Absolute GDP by 17 Regions and SSP Scenarios (1980-2050)', 'Billion USD', 'absolute_gdp_17regions_1980_2050.png')
plot_grid(full_idx, 'GDP_Indexed', 'Indexed GDP (2020=100) by 17 Regions and SSP Scenarios (1980-2050)', 'Index (2020=100)', 'indexed_gdp_17regions_1980_2050.png', add_hline=True)

# 저장
full_abs.to_csv('GDP_Absolute_17Regions_1980_2050.csv', index=False)
full_idx.to_csv('GDP_Indexed_17Regions_1980_2050.csv', index=False)
