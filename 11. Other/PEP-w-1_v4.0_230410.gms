...
$GDXIN DATA_AGG-2019_230410_POWER3.gdx
...
$CALL GDXXRW.EXE VAL_230410_PAR.xls squeeze = 'no' par=sigma_KD rng=PAR!A5:R36 par=sigma_LD rng=PAR!A39:R70 par=sigma_X1 rng=PAR!A73:R104 par=sigma_X2 rng=PAR!A107:R138 par=sigma_y rng=PAR!A141:R172 par=PARZ rng=PAR!A174:C191 par=sigma_inv rng=PAR!A194:R225 Rdim=2 Cdim=1
$GDXIN VAL_230410_PAR.gdx
...
display PETO, EXO, EXTO, rho_X1, DSO, PLO, rho_X1, beta_EX_X1, beta_D_X1, B_X1, DSO, EXTO ;
...
display rho_X1, beta_EX_X1, beta_D_X1, B_X1, rho_X2, beta_X2, B_X2, sigma_m1 ;
...
display  rho_M1, beta_M1, B_M1, rho_M2, beta_M2, B_M2 ;
