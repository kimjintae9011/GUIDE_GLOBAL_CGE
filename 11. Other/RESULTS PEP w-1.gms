...
*==============================================================================
 ...
 valDI(i,j,z,scen)       Intermediate consumption of commodity i by industry j in region z
 valDIT(i,z,scen)        Total intermediate demand of commodity i in region z
 valDS(i,z,scen)         Supply of commodity i to the domestic market of region z
 ...
 valP(j,z,scen)          Basic price of industry j production in region z
 ...
 valTIP(i,z,scen)        Government revenue from taxes on industry j production in region z (excluding taxes directly related to the use of capital and labor)
 ...
 valXS(j,z,scen)         Total output of industry j in region z
...
*==============================================================================
 ...
 valDEP(z,'bau')         = DEPO(z);
 valDI(i,j,z,'bau')      = DIO(i,j,z);
 valDIT(i,z,'bau')       = DITO(i,z);
 valDS(i,z,'bau')        = DSO(i,z);
 vale(z,'bau')           = eO(z);
...
*==============================================================================
 ...
 valDI(i,j,z,'sim')      = DI.l(i,j,z);
 valDIT(i,z,'sim')       = DIT.l(i,z);
 valDS(i,z,'sim')        = DS.l(i,z);
 vale(z,'sim')           = e.l(z);
...
*==============================================================================
 ...
 FishQEX(z,scen)
         = {[(eO(z)*SUM[(j,zj),valEX(j,z,zj,scen)*PWXO(j,z,zj)]+
              eO(z)*SUM[j,valMRGN(j,z,scen)*PWMGO(j)])
              /
             (eO(z)*SUM[(j,zj),EXO(j,z,zj)*PWXO(j,z,zj)]+
              eO(z)*SUM[j,MRGNO(j,z)*PWMGO(j)])
             ]*[
             (vale(z,scen)*SUM[(j,zj),valEX(j,z,zj,scen)*valPWX(j,z,zj,scen)]+
              vale(z,scen)*SUM[j,valMRGN(j,z,scen)*valPWMG(j,scen)])
              /
             (vale(z,scen)*SUM[(j,zj),EXO(j,z,zj)*valPWX(j,z,zj,scen)]+
              vale(z,scen)*SUM[j,MRGNO(j,z)*valPWMG(j,scen)])
             ]}**0.5;
