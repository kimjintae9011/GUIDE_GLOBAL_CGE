...
***** CBAM revenue recycling: s1, s2 for z5 *****
...
*==============================================================================
 EQ33(z)..       YROW(z) =e= e(z)*SUM{(i,zj)$IMO(i,zj,z),IM(i,zj,z)*
                           [PWM(i,zj,z)+SUM(ij,PWMG(ij)*tmrg(ij,i,zj,z))]}+TCBAM(z)$z3(z);

 EQ34(z)..       SROW(z) =e= YROW(z)-e(z)*SUM[(i,zj)$EXO(i,z,zj),
                               EX(i,z,zj)*PWX(i,z,zj)]-e(z)
                               *SUM[i$MRGNO(i,z),MRGN(i,z)*PWMG(i)]-[TCBAM('07_EU')/card(z5)]$z5(z);
...
*==============================================================================
 ...
 YROW.L(z)        = YROWO(z);
 CP.L(z)          = CP0(z);
 deltattiw.l(l,j,z) = deltattiwO(l,j,z);
 ttiw.L(l,j,z)    = ttiwO(l,j,z);
...
execute_unload 'Output_w-1/4_CBAM_LAB.gdx'
