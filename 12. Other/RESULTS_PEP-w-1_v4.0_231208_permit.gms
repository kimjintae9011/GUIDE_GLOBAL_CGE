...
*==============================================================================
 ...
 valTPERMIT(z,scen)      Government revenue from Emission Trading System
 valPPERMIT(z,scen)      Permit Price
 valPERMIT(j,z,scen)     Permit 
 valPERMIT_TOTAL(z,scen) Total Permit
...
* valRK(k,z,'bau')        = RKO(k,z);
 ...
 valTPERMIT(z,'bau')     = 0;
 valPERMIT(j,z,'bau')    = PERMITO(j,z);
 valPERMIT_Total(z,'bau')= PERMIT_TOTALO(z);
 valPPERMIT(z,'bau')     = 0;
...
* valRK(k,z,'sim')        = RK.l(k,z);
 ...
 valTPERMIT(z,'sim')     = TPERMIT.l(z);
 valPERMIT(j,z,'sim')    = PERMIT.L(j,z);
 valPERMIT_Total(z,'sim')= PERMIT_TOTAL.L(z);
 valPPERMIT(z,'sim')     = PPERMIT.L(z);
...
*==============================================================================
execute_unload 'results_PEP-w-1_v4.0_231208_permit',
 valC
 valCAB
 valCABX
 valCG
