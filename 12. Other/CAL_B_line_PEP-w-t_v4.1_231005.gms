...
*                       = GDP_BP_REAL.l(z,time-1)*[1+g_GDP(z,time-1)];
                       = GDP_BP_REAL.l(z,time-1)*[1+0.01];
*                       = GDP_BP_REAL.l(z,time-1);

GDP_BP_REAL.fx(z2,time)$[ord(time) gt 1]
                      = GDP_BP_REAL.l(z2,time-1)*[1+g_GDP(z2,time-1)];
...
execute_unload 'B_line',
 A_VA_RES, sh0X, sh1X, GX, G_REALX, INDX, delta, XST, VA, LS, KS, LD, KD, IND, cabix, sigma_LD, EX, exogro, GDP_BP, RC, IT, SH, SG;
