...
$GDXIN JointB_DATA_AGG-2019_230111_MNG.gdx
...
$CALL gdxxrw JointB_VAL_230309_PAR.xls @JointB_PAR.txt trace=0
$GDXIN JointB_VAL_230309_PAR.gdx
$LOAD sigma_KD, sigma_LD, sigma_X1, sigma_X2, sigma_X0, sigma_X3, sigma_y, PARZ
...
* B_X3(i,z)     = XSO_I(i,z)
*                  /SUM[jj$XSO(jj,i,z),beta_X3(i,jj,z)*XSO(jj,i,z)**(-rho_X3(i,z))
*                  ]**(-1/rho_X3(i,z));
...
display sigma_m1, rho_M1, beta_M1, B_M1 ;
$exit
...
*[IFRI]
* EQB_2(j,i,z)$beta_X3(j,i,z)..
*                  P2(j,i,z)=e=
*                  PI(i,z)
*                  *XS_I(i,z)*sum(jj, beta_X3(jj,i,z)*XS(jj,i,z)**(-rho_X3(i,z)))**(-1)
*                  *beta_X3(j,i,z)*XS(j,i,z)**(-rho_X3(i,z)-1)  ;

* EQB_3(j,z)..  PT(j,z) =e= SUM(i, P2(j,i,z)*theta2(j,i,z) );

*[Leontief function option]
* EQA_1(j,i,z)${DSO(j,i,z) and [DSO(j,i,z) eq DSO_I(i,z)]}..  XS(j,i,z) =e= theta2(j,i,z)*XS_I(i,z);
* EQA_2(j,i,z)$[DSO(j,i,z)]..   DS(j,i,z) =e= theta2(j,i,z)*DS_I(i,z);
...
*execute_unload 'JointB_Result', XS, XSO, XS_I, XSO_I, PI, PP, P2, PD, PO, ttic, PTO, PT, PMT, PM, beta_X3;

execute_unload 'JointB_Result',
XSO, P2, XS, DS, DSO, PET, EXT, EXTO, MRGN, PWMG, PL,beta_X3, EXTO, EXTTO  ;
