...
* beta_LD(l,j,z)               Share parameter (CES - composite labor)
 ...
 PERMIT_NDC(z,time)     PERMIT
 PERMIT_NZS(z,time)      PERMIT
 PERMIT_NEA_NZS(z,time)      PERMIT
...
$LOAD TOT_POP, g_GDP, g_POP, g_SDR, AEEI_low, AEEI_high, PERMIT_NDC, PERMIT_NZS, PERMIT_NEA_NZS
...
*==============================================================================
 ...
 CTAX(PERMIT2_Z,time)            Carbon tax in region z
 CTAX_NEA(time)
*==============================================================================
...
*Nested CES
 ...
 EQ9_7(ene5,j2,PERMIT2_Z,time)
 EQ9_7_1(ene5,j2,NEA,time)
 EQ9_8(ene6,j2,PERMIT2_Z,time)
 EQ9_8_1(ene6,j2,NEA,time)
...
* CALEQ1(z,time)         Aggregate domestic savings
 ...
 EQ16_1(PERMIT2_Z,time)      Government revenue from Ctax
 EQ16_1_1(NEA,time)
...
*Nested CES
 EQ51_1(j2,z,time)
 EQ51_2(j3,PERMIT2_Z,time)
 EQ51_2_1(j3,NEA,time)
 EQ51_3(j2,z,time)
 EQ51_3(j2,z,time)
 EQ51_4(j2,z,time)
 EQ51_5(j2,PERMIT2_Z,time)
 EQ51_5_1(j2,NEA,time)
 EQ51_6(j2,PERMIT2_Z,time)
 EQ51_6_1(j2,NEA,time)
...
*=============================Level 1, 2, 3 (CES) =======================================
 ...
 EQ9_7(ene5,j2,PERMIT2_Z,t)..   DE(ene5,j2,PERMIT2_Z,t) =e= [beta_ENER5_1(ene5,j2,PERMIT2_Z)*PCEcoalgas(j2,PERMIT2_Z,t)/(P4(ene5,j2,PERMIT2_Z,t)+P4(ene5,j2,PERMIT2_Z,t)*CTAX(PERMIT2_Z,t)*CO2FACTOR2(ene5,j2,PERMIT2_Z,t))]
                                            **sigma_ENER5_1(j2,PERMIT2_Z)*B_ENER5_1(j2,PERMIT2_Z)**(sigma_ENER5_1(j2,PERMIT2_Z)-1)
                                            *DEcoalgas(j2,PERMIT2_Z,t);

 EQ9_7_1(ene5,j2,NEA,t)..   DE(ene5,j2,NEA,t) =e= [beta_ENER5_1(ene5,j2,NEA)*PCEcoalgas(j2,NEA,t)/(P4(ene5,j2,NEA,t)+P4(ene5,j2,NEA,t)*CTAX_NEA(t)*CO2FACTOR2(ene5,j2,NEA,t))]
                                            **sigma_ENER5_1(j2,NEA)*B_ENER5_1(j2,NEA)**(sigma_ENER5_1(j2,NEA)-1)
                                            *DEcoalgas(j2,NEA,t);

 EQ9_8(ene6,j2,PERMIT2_Z,t)..   DE(ene6,j2,PERMIT2_Z,t) =e= [beta_ENER5_2(ene6,j2,PERMIT2_Z)*PCEoilpetrol(j2,PERMIT2_Z,t)/(P4(ene6,j2,PERMIT2_Z,t)+P4(ene6,j2,PERMIT2_Z,t)*CTAX(PERMIT2_Z,t)*CO2FACTOR2(ene6,j2,PERMIT2_Z,t))]
                                            **sigma_ENER5_2(j2,PERMIT2_Z)*B_ENER5_2(j2,PERMIT2_Z)**(sigma_ENER5_2(j2,PERMIT2_Z)-1)
                                            *DEoilpetrol(j2,PERMIT2_Z,t);

 EQ9_8_1(ene6,j2,NEA,t)..   DE(ene6,j2,NEA,t) =e= [beta_ENER5_2(ene6,j2,NEA)*PCEoilpetrol(j2,NEA,t)/(P4(ene6,j2,NEA,t)+P4(ene6,j2,NEA,t)*CTAX_NEA(t)*CO2FACTOR2(ene6,j2,NEA,t))]
                                            **sigma_ENER5_2(j2,NEA)*B_ENER5_2(j2,NEA)**(sigma_ENER5_2(j2,NEA)-1)
                                            *DEoilpetrol(j2,NEA,t);
*==============================================================================
...
*==============================================================================
 ...
 EQ16_1(PERMIT2_Z,t)..    TCTAX(PERMIT2_Z,t) =e= sum((ene,j), PC(ene,PERMIT2_Z,t)*CTAX(PERMIT2_Z,t)*CO2FACTOR2(ene,j,PERMIT2_Z,t)*DE(ene,j,PERMIT2_Z,t));

 EQ16_1_1(NEA,t)..    TCTAX(NEA,t) =e= sum((ene,j), PC(ene,NEA,t)*CTAX_NEA(t)*CO2FACTOR2(ene,j,NEA,t)*DE(ene,j,NEA,t));
...
*================================= Level 1-5 ======================================
 EQ51_2(j3,PERMIT2_Z,t)..   PCE(j3,PERMIT2_Z,t)*CE(j3,PERMIT2_Z,t) =e= SUM[ene,PC(ene,PERMIT2_Z,t)*DE(ene,j3,PERMIT2_Z,t)+PC(ene,PERMIT2_Z,t)*CTAX(PERMIT2_Z,t)*CO2FACTOR2(ene,j3,PERMIT2_Z,t)*DE(ene,j3,PERMIT2_Z,t)];

 EQ51_2_1(j3,NEA,t)..   PCE(j3,NEA,t)*CE(j3,NEA,t) =e= SUM[ene,PC(ene,NEA,t)*DE(ene,j3,NEA,t)+PC(ene,NEA,t)*CTAX_NEA(t)*CO2FACTOR2(ene,j3,NEA,t)*DE(ene,j3,NEA,t)];
 ...
 EQ51_5(j2,PERMIT2_Z,t)..   PCEcoalgas(j2,PERMIT2_Z,t)*DEcoalgas(j2,PERMIT2_Z,t) =e= [PC("02_COAL",PERMIT2_Z,t)*DE("02_COAL",j2,PERMIT2_Z,t)+PC("02_COAL",PERMIT2_Z,t)*CTAX(PERMIT2_Z,t)*CO2FACTOR2("02_COAL",j2,PERMIT2_Z,t)*DE("02_COAL",j2,PERMIT2_Z,t)
                    +PC("04_GAS",PERMIT2_Z,t)*DE("04_GAS",j2,PERMIT2_Z,t)+PC("04_GAS",PERMIT2_Z,t)*CTAX(PERMIT2_Z,t)*CO2FACTOR2("04_GAS",j2,PERMIT2_Z,t)*DE("04_GAS",j2,PERMIT2_Z,t)];

 EQ51_5_1(j2,NEA,t)..   PCEcoalgas(j2,NEA,t)*DEcoalgas(j2,NEA,t) =e= [PC("02_COAL",NEA,t)*DE("02_COAL",j2,NEA,t)+PC("02_COAL",NEA,t)*CTAX_NEA(t)*CO2FACTOR2("02_COAL",j2,NEA,t)*DE("02_COAL",j2,NEA,t)
                    +PC("04_GAS",NEA,t)*DE("04_GAS",j2,NEA,t)+PC("04_GAS",NEA,t)*CTAX_NEA(t)*CO2FACTOR2("04_GAS",j2,NEA,t)*DE("04_GAS",j2,NEA,t)];

 EQ51_6(j2,PERMIT2_Z,t)..   PCEoilpetrol(j2,PERMIT2_Z,t)*DEoilpetrol(j2,PERMIT2_Z,t) =e= [PC("03_OIL",PERMIT2_Z,t)*DE("03_OIL",j2,PERMIT2_Z,t)+PC("03_OIL",PERMIT2_Z,t)*CTAX(PERMIT2_Z,t)*CO2FACTOR2("03_OIL",j2,PERMIT2_Z,t)*DE("03_OIL",j2,PERMIT2_Z,t)
                    +PC("10_PETROLCOAL",PERMIT2_Z,t)*DE("10_PETROLCOAL",j2,PERMIT2_Z,t)+PC("10_PETROLCOAL",PERMIT2_Z,t)*CTAX(PERMIT2_Z,t)*CO2FACTOR2("10_PETROLCOAL",j2,PERMIT2_Z,t)*DE("10_PETROLCOAL",j2,PERMIT2_Z,t)];

 EQ51_6_1(j2,NEA,t)..   PCEoilpetrol(j2,NEA,t)*DEoilpetrol(j2,NEA,t) =e= [PC("03_OIL",NEA,t)*DE("03_OIL",j2,NEA,t)+PC("03_OIL",NEA,t)*CTAX_NEA(t)*CO2FACTOR2("03_OIL",j2,NEA,t)*DE("03_OIL",j2,NEA,t)
                    +PC("10_PETROLCOAL",NEA,t)*DE("10_PETROLCOAL",j2,NEA,t)+PC("10_PETROLCOAL",NEA,t)*CTAX_NEA(t)*CO2FACTOR2("10_PETROLCOAL",j2,NEA,t)*DE("10_PETROLCOAL",j2,NEA,t)];
...
*==============================================================================
 ...
 EQ83(z,t)..       GDP_IB(z,t) =e= SUM[(j)$LDO(j,z),W(z,t)*LD(j,z,t)]
...
*==============================================================================
 ...
 EQ108(PERMIT2_Z,t)..  PERMIT_TOTAL(PERMIT2_Z,t) =e=  sum(j,PERMIT(j,PERMIT2_Z,t))  ;
 
 EQ108_1(t).. PERMIT_NEA_TOTAL(t) =e= sum((NEA,j), PERMIT(j,NEA,t) ); 
