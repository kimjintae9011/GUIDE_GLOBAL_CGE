...
PARAMETER
 ...
 valPERMIT_TOTAL(PERMIT2_Z,time,scen) Total emissions
...
*================== Carbon Tax ====================================================================
 valCTAX(PERMIT2_Z,time,scen) CTAX
 valCTAX_NEA(time,scen) CTAX
...
*==============================================================================
 ...
 valPERMIT_TOTAL(PERMIT2_Z,time,'NZS') = PERMIT_TOTAL.l(PERMIT2_Z,time);
 valPERMIT_NEA_TOTAL(time,'NZS') =  PERMIT_NEA_TOTAL.l(time);
...
*=============================== Energy =====================================================================
 ...
 valEE(p_waste,j,z,time,'NZS')          =  EEI(p_waste,j,z)*valXST(j,z,time,'NZS') ;
 valEE(p_bio,j,z,time,'NZS')            =  EEI(p_bio,j,z)*valXST(j,z,time,'NZS') ;
 valEE(p_charcoal,j,z,time,'NZS')       =  EEI(p_charcoal,j,z)*valXST(j,z,time,'NZS');
 ...
 valEH(p_waste,z,time,'NZS')            =  EHI(p_waste,z)*TOT_POP(z,time) ;
 valEH(p_bio,z,time,'NZS')              =  EHI(p_bio,z)*TOT_POP(z,time) ;
 valEH(p_charcoal,z,time,'NZS')         =  EHI(p_charcoal,z)*TOT_POP(z,time) ;
...
*============================== Carbon Tax ============================================
 valCTAX(PERMIT2_Z,time,'NZS') = CTAX.l(PERMIT2_Z,time) ;
 valCTAX_NEA(time,'NZS') = CTAX_NEA.l(time) ;
...
*=====================================================================================================
 ...
 execute_unload 'Output_w-t\NZS_NEA_Results_GTAP11c_new.gdx',
*$Ontext
 valA_VA,
 valC,
 valCAB,
