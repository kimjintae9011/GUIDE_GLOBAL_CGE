...
*==============================================================================
 ...
 PERMIT_TOTAL.L(PERMIT2_Z,t1)       = PERMIT_TOTALO(PERMIT2_Z);
 CTAX.L(PERMIT2_Z,t1)               = CTAX0(PERMIT2_Z);
 CTAX_NEA.L(t1)               = 0;
...
*==============================================================================
 ...
 PERMIT_TOTAL.L(PERMIT2_Z,time)     = PERMIT_TOTAL.L(PERMIT2_Z,time-1);
 CTAX.L(PERMIT2_Z,time)             = CTAX.L(PERMIT2_Z,time-1);
 CTAX_NEA.L(time)                       = CTAX_NEA.L(time-1);
